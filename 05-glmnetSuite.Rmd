...
```{r lsso-simRes-errors-bySim, cache=T, cache.vars='what-to-keep', fig.heigth=5, fig.width=10, fig.cap='lasso Model Errors by Sample Size'}
...
```{r lasso-simRes-features-bySim, cache=T, cache.vars='what-to-keep', fig.heigth=5, fig.width=10, fig.cap='lasso Models Selected Features by Sample Size'}
