...
Using a larger dataset focusing on hepatocellular carcinoma, Cai et al. (2019) [@Cai:2019aa]
demonstrated the  feasibility using features derived from 
5-hydroxymethylcytosines marks in circulating cell-free DNA as 
a non-invasive approach for early detection of
...
that development should take.  The purpose of this article is to examine this dataset 
to try and shed some light on this question.
