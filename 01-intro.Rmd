...
* In Section \@ref(hcc-5hmcseq-preproc) we preprocess the 5hmC data that
...
* In Section \@ref(hcc5-hmcseq-model-suite) we examine the results of fitting a suite of models to
