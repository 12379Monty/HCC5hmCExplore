...
\CommentTok{\# Strip GSE\_ID prefix from object names}
\CommentTok{\#\#\# MOD: (2020.09.21) keep \textquotesingle{}hcc5hmC\_\textquotesingle{} as prefix to object names. }
\CommentTok{\#\#\#     Otherwise we run into problems when different datasets are }
\CommentTok{\#\#\#     analyzed}
\ControlFlowTok{for}\NormalTok{(OBJ }\ControlFlowTok{in} \KeywordTok{data}\NormalTok{(}\DataTypeTok{package=}\StringTok{\textquotesingle{}GSE112679\textquotesingle{}}\NormalTok{)}\OperatorTok{$}\NormalTok{results[, }\StringTok{\textquotesingle{}Item\textquotesingle{}}\NormalTok{])}
\KeywordTok{assign}\NormalTok{(}\KeywordTok{sub}\NormalTok{(}\StringTok{\textquotesingle{}GSE112679\_\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}hcc5hmC\_\textquotesingle{}}\NormalTok{,OBJ), }\KeywordTok{get}\NormalTok{(OBJ))}

\KeywordTok{detach}\NormalTok{(package}\OperatorTok{:}\NormalTok{GSE112679, }\DataTypeTok{unload =}\NormalTok{ T )}

\CommentTok{\# Continue}

\NormalTok{hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{DxStage <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(hcc5hmC\_sampDesc, }\KeywordTok{ifelse}\NormalTok{(outcome}\OperatorTok{==}\StringTok{\textquotesingle{}HCC\textquotesingle{}}\NormalTok{, }
...
\NormalTok{  hcc5hmC\_sampDesc }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(sampType }\OperatorTok{==}\StringTok{ "blood"}\NormalTok{),}
...
\CommentTok{\# Subset analysis samples}
\NormalTok{hcc5hmC\_sampDesc <{-}}
\StringTok{  }\NormalTok{hcc5hmC\_sampDesc }\OperatorTok{\%>\%}
...
\NormalTok{hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{group <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(}
\NormalTok{  hcc5hmC\_sampDesc,}
  \KeywordTok{ifelse}\NormalTok{(group }\OperatorTok{==}\StringTok{ "BenignHealthy"}\NormalTok{, }\StringTok{"Control"}\NormalTok{, group)}
\NormalTok{)}
\CommentTok{\# set hcc5hmC\_groupCol for later}
\NormalTok{hcc5hmC\_groupCol <{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"\#F3C300"}\NormalTok{, }\StringTok{"\#875692"}\NormalTok{)}
\KeywordTok{names}\NormalTok{(hcc5hmC\_groupCol) <{-}}\StringTok{ }\KeywordTok{unique}\NormalTok{(hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{group)}

\KeywordTok{with}\NormalTok{(hcc5hmC\_sampDesc, }
...
\caption{\label{tab:hcc5hmC-preproc-subsetSamples}Samples used in this analysis}
\centering
\begin{tabular}[t]{l|r}
\hline
group & Freq\\
...
\KeywordTok{boxplot}\NormalTok{(}\KeywordTok{log2}\NormalTok{(hcc5hmC\_featureCounts }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{),}
  ...
  \DataTypeTok{border =}\NormalTok{ hcc5hmC\_groupCol[hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{group]}
\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"top"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{names}\NormalTok{(hcc5hmC\_groupCol), }\DataTypeTok{text.col =}\NormalTok{ hcc5hmC\_groupCol, }
  \DataTypeTok{ncol =} \DecValTok{2}\NormalTok{, }\DataTypeTok{bty =} \StringTok{"n"}\NormalTok{)}
\CommentTok{\# Add reference lines}
\NormalTok{SampleMedian <{-}}\StringTok{ }\KeywordTok{apply}\NormalTok{(}\KeywordTok{log2}\NormalTok{(hcc5hmC\_featureCounts }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{), }\DecValTok{2}\NormalTok{, median)}
...
\KeywordTok{plot}\NormalTok{(}\KeywordTok{density}\NormalTok{(hcc5hmC\_lcpm\_mtx[, }\DecValTok{1}\NormalTok{]),}
  \DataTypeTok{col =}\NormalTok{ hcc5hmC\_groupCol[hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{group[}\DecValTok{1}\NormalTok{]],}
...
\ControlFlowTok{for}\NormalTok{ (JJ }\ControlFlowTok{in} \KeywordTok{sample}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(hcc5hmC\_lcpm\_mtx), }\DataTypeTok{size =} \DecValTok{100}\NormalTok{)) \{}
\NormalTok{  den <{-}}\StringTok{ }\KeywordTok{density}\NormalTok{(hcc5hmC\_lcpm\_mtx[, JJ])}
  \KeywordTok{lines}\NormalTok{(den}\OperatorTok{$}\NormalTok{x, den}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{col =}\NormalTok{ hcc5hmC\_groupCol[hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{group[JJ]], }\DataTypeTok{lwd =} \DecValTok{2}\NormalTok{)}
\NormalTok{\} }\CommentTok{\# for(JJ}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{names}\NormalTok{(hcc5hmC\_groupCol), }
  \DataTypeTok{text.col =}\NormalTok{ hcc5hmC\_groupCol, }\DataTypeTok{bty =} \StringTok{"n"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mar =} \KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(}\KeywordTok{density}\NormalTok{(hcc5hmC\_F\_lcpm\_mtx[, }\DecValTok{1}\NormalTok{]),}
  \DataTypeTok{col =}\NormalTok{ hcc5hmC\_groupCol[hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{group[}\DecValTok{1}\NormalTok{]],}
  \DataTypeTok{lwd =} \DecValTok{2}\NormalTok{, }\DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{.25}\NormalTok{), }\DataTypeTok{las =} \DecValTok{2}\NormalTok{, }\DataTypeTok{main =} \StringTok{""}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"log2 CPM"}
\NormalTok{)}
\CommentTok{\#abline(v = 0, col = 3)}
\CommentTok{\# After verifying no outliers, can plot a random subset }
\ControlFlowTok{for}\NormalTok{ (JJ }\ControlFlowTok{in} \KeywordTok{sample}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(hcc5hmC\_F\_lcpm\_mtx), }\DataTypeTok{size =} \DecValTok{100}\NormalTok{)) \{}
\NormalTok{  den <{-}}\StringTok{ }\KeywordTok{density}\NormalTok{(hcc5hmC\_F\_lcpm\_mtx[, JJ])}
  \KeywordTok{lines}\NormalTok{(den}\OperatorTok{$}\NormalTok{x, den}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{col =}\NormalTok{ hcc5hmC\_groupCol[hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{group[JJ]], }\DataTypeTok{lwd =} \DecValTok{2}\NormalTok{)}
\NormalTok{\} }\CommentTok{\# for(JJ}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{names}\NormalTok{(hcc5hmC\_groupCol), }
  \DataTypeTok{text.col =}\NormalTok{ hcc5hmC\_groupCol, }\DataTypeTok{bty =} \StringTok{"n"}\NormalTok{)}
...
\begin{figure}
\centering
\includegraphics{Static/figures/hcc5hmC-preproc-densityLcpm2-1.pdf}
\caption{\label{fig:hcc5hmC-preproc-densityLcpm2}Sample \(log_2\) CPM densities after removing weak genes}
\end{figure}
...
\NormalTok{hcc5hmC\_F\_dgel <{-}}\StringTok{ }\NormalTok{edgeR}\OperatorTok{::}\KeywordTok{DGEList}\NormalTok{(}
  \DataTypeTok{counts =}\NormalTok{ hcc5hmC\_featureCounts\_F,}
  \DataTypeTok{genes =}\NormalTok{ hcc5hmC\_genes\_annot\_F,}
  \DataTypeTok{samples =}\NormalTok{ hcc5hmC\_sampDesc,}
  \DataTypeTok{group =}\NormalTok{ hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{group}
\NormalTok{)}
\NormalTok{hcc5hmC\_F\_dgel <{-}}\StringTok{ }\NormalTok{edgeR}\OperatorTok{::}\KeywordTok{calcNormFactors}\NormalTok{(hcc5hmC\_F\_dgel)}
\NormalTok{hcc5hmC\_F\_lcpm\_mtx <{-}}\StringTok{ }\NormalTok{edgeR}\OperatorTok{::}\KeywordTok{cpm}\NormalTok{(hcc5hmC\_F\_dgel, }\DataTypeTok{log =}\NormalTok{ T)}

\CommentTok{\# Save hcc5hmC\_F\_dgel to facilitate restarting}
\CommentTok{\# remove from final version}
\KeywordTok{save}\NormalTok{(}\DataTypeTok{list =} \StringTok{"hcc5hmC\_F\_dgel"}\NormalTok{, }\DataTypeTok{file =} \StringTok{"RData/hcc5hmC\_F\_dgel"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mar =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\KeywordTok{boxplot}\NormalTok{(hcc5hmC\_F\_lcpm\_mtx,}
...
\KeywordTok{legend}\NormalTok{(}\StringTok{"top"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{names}\NormalTok{(hcc5hmC\_groupCol), }\DataTypeTok{text.col =}\NormalTok{ hcc5hmC\_groupCol,}
  \DataTypeTok{ncol =} \DecValTok{2}\NormalTok{, }\DataTypeTok{bty =} \StringTok{"n"}\NormalTok{)}
\CommentTok{\# Add reference lines}
\NormalTok{SampleMedian <{-}}\StringTok{ }\KeywordTok{apply}\NormalTok{(hcc5hmC\_F\_lcpm\_mtx, }\DecValTok{2}\NormalTok{, median)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{h =} \KeywordTok{median}\NormalTok{(SampleMedian), }\DataTypeTok{col =} \StringTok{"grey"}\NormalTok{)}
\KeywordTok{axis}\NormalTok{(}\DataTypeTok{side =} \DecValTok{4}\NormalTok{, }\DataTypeTok{at =} \KeywordTok{round}\NormalTok{(}\KeywordTok{median}\NormalTok{(SampleMedian), }\DecValTok{1}\NormalTok{),}
  \DataTypeTok{las =} \DecValTok{2}\NormalTok{, }\DataTypeTok{col =} \StringTok{"grey"}\NormalTok{, }\DataTypeTok{line =} \DecValTok{{-}1}\NormalTok{, }\DataTypeTok{tick =}\NormalTok{ F)}
\end{Highlighting}
...
\begin{figure}
\centering
\includegraphics{Static/figures/hcc5hmC-preproc-normedLcpmBxp-1.pdf}
\caption{\label{fig:hcc5hmC-preproc-normedLcpmBxp}Sample log2 count boxplots}
\end{figure}
...
\NormalTok{samp\_ndx <{-}}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(hcc5hmC\_F\_lcpm\_mtx), }\DataTypeTok{size =} \DecValTok{500}\NormalTok{)}
\NormalTok{MDS.out <{-}}\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{plotMDS}\NormalTok{(hcc5hmC\_F\_lcpm\_mtx[, samp\_ndx],}
  \DataTypeTok{col =}\NormalTok{ hcc5hmC\_groupCol[hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{group[samp\_ndx]], }\DataTypeTok{pch =} \DecValTok{1}
\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{,}
  \DataTypeTok{legend =} \KeywordTok{names}\NormalTok{(hcc5hmC\_groupCol),}
  \DataTypeTok{text.col =}\NormalTok{ hcc5hmC\_groupCol, }\DataTypeTok{bty =} \StringTok{"n"}
\NormalTok{)}

\NormalTok{MDS.out <{-}}\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{plotMDS}\NormalTok{(hcc5hmC\_F\_lcpm\_mtx[, samp\_ndx],}
  \DataTypeTok{col =}\NormalTok{ hcc5hmC\_groupCol[hcc5hmC\_sampDesc}\OperatorTok{$}\NormalTok{group[samp\_ndx]], }\DataTypeTok{pch =} \DecValTok{1}\NormalTok{,}
...
\begin{figure}
\centering
\includegraphics{Static/figures/hcc5hmC-preproc-plotMDS-1.pdf}
\caption{\label{fig:hcc5hmC-preproc-plotMDS}MDS plots of log-CPM values}
\end{figure}
...
\NormalTok{Glimma}\OperatorTok{::}\KeywordTok{glMDSPlot}\NormalTok{(hcc5hmC\_F\_dgel[, samp\_ndx],}
  \DataTypeTok{groups =}\NormalTok{ hcc5hmC\_F\_dgel}\OperatorTok{$}\NormalTok{samples[}
\NormalTok{    samp\_ndx,}
...
\NormalTok{Design\_mtx <{-}}\StringTok{ }\KeywordTok{model.matrix}\NormalTok{( }\OperatorTok{\textasciitilde{}}\StringTok{  }\DecValTok{{-}1} \OperatorTok{+}\StringTok{ }\NormalTok{group, }\DataTypeTok{data=}\NormalTok{hcc5hmC\_F\_dgel}\OperatorTok{$}\NormalTok{samples)}
...
\NormalTok{ hcc5hmC\_F\_voom\_fit <{-}}\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{lmFit}\NormalTok{(hcc5hmC\_F\_voom, Design\_mtx)}
 \KeywordTok{colnames}\NormalTok{(hcc5hmC\_F\_voom\_fit}\OperatorTok{$}\NormalTok{coefficients) <{-}}\StringTok{ }\KeywordTok{sub}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{(Intercept}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{)"}\NormalTok{, }\StringTok{"Intercept"}\NormalTok{,}
 \KeywordTok{colnames}\NormalTok{(hcc5hmC\_F\_voom\_fit}\OperatorTok{$}\NormalTok{coefficients) )}

\NormalTok{ hcc5hmC\_F\_voom\_fit <{-}}\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{contrasts.fit}\NormalTok{(}
\NormalTok{    hcc5hmC\_F\_voom\_fit, }\DataTypeTok{contrasts=}\NormalTok{Contrasts\_mtx)}

\NormalTok{ hcc5hmC\_F\_voom\_efit <{-}}\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{eBayes}\NormalTok{(hcc5hmC\_F\_voom\_fit)}

\NormalTok{ hcc5hmC\_F\_voom\_efit\_dt <{-}}
\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{decideTests}\NormalTok{(hcc5hmC\_F\_voom\_efit,}\DataTypeTok{adjust.method =} \StringTok{"BH"}\NormalTok{, }\DataTypeTok{p.value =} \FloatTok{0.05}\NormalTok{)}
 
\NormalTok{ knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{t}\NormalTok{(}\KeywordTok{summary}\NormalTok{(hcc5hmC\_F\_voom\_efit\_dt)),}
...
\NormalTok{limma}\OperatorTok{::}\KeywordTok{plotMD}\NormalTok{(hcc5hmC\_F\_voom\_efit,}
 ...
 \DataTypeTok{status=}\NormalTok{hcc5hmC\_F\_voom\_efit\_dt[,}\StringTok{\textquotesingle{}HCCvsControl\textquotesingle{}}\NormalTok{],}
 ...
 \DataTypeTok{xlab =} \KeywordTok{paste0}\NormalTok{(}
    ...
    \KeywordTok{paste}\NormalTok{(}\KeywordTok{round}\NormalTok{(}\KeywordTok{quantile}\NormalTok{(hcc5hmC\_F\_voom\_efit}\OperatorTok{$}\NormalTok{Amean, }\DataTypeTok{prob =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{/}\StringTok{ }\DecValTok{4}\NormalTok{), }\DecValTok{2}\NormalTok{),}
      \DataTypeTok{collapse =} \StringTok{", "}
\NormalTok{    )}
\NormalTok{  ),}
  \DataTypeTok{ylab =} \KeywordTok{paste0}\NormalTok{(}
    \StringTok{"log{-}fold{-}change: IQR="}\NormalTok{,}
    \KeywordTok{paste}\NormalTok{(}\KeywordTok{round}\NormalTok{(}\KeywordTok{quantile}\NormalTok{(hcc5hmC\_F\_voom\_efit}\OperatorTok{$}\NormalTok{coefficients[, }\StringTok{\textquotesingle{}HCCvsControl\textquotesingle{}}\NormalTok{], }\DataTypeTok{prob =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{/}\StringTok{ }\DecValTok{4}\NormalTok{), }\DecValTok{2}\NormalTok{),}
      \DataTypeTok{collapse =} \StringTok{", "}
\NormalTok{    )}
\NormalTok{  ),}
...
\KeywordTok{rug}\NormalTok{(}\KeywordTok{quantile}\NormalTok{(hcc5hmC\_F\_voom\_efit}\OperatorTok{$}\NormalTok{coefficients[, }\StringTok{\textquotesingle{}HCCvsControl\textquotesingle{}}\NormalTok{], }\DataTypeTok{prob =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{/}\StringTok{ }\DecValTok{4}\NormalTok{),}
...
\NormalTok{)}
\KeywordTok{rug}\NormalTok{(}\KeywordTok{quantile}\NormalTok{(hcc5hmC\_F\_voom\_efit}\OperatorTok{$}\NormalTok{Amean, }\DataTypeTok{prob =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{/}\StringTok{ }\DecValTok{4}\NormalTok{),}
  \DataTypeTok{col =} \StringTok{"purple"}\NormalTok{,}
...
\NormalTok{ hcc5hmC\_F\_voom\_efit}\OperatorTok{$}\NormalTok{coefficients[, }\StringTok{\textquotesingle{}HCCvsControl\textquotesingle{}}\NormalTok{],}
\NormalTok{ hcc5hmC\_F\_voom\_efit\_dt[,}\StringTok{\textquotesingle{}HCCvsControl\textquotesingle{}}\NormalTok{]),}
...
\NormalTok{genes\_ndx <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(}\KeywordTok{rownames}\NormalTok{(hcc5hmC\_F\_voom\_efit), hcc5hmC\_genes\_annot\_F}\OperatorTok{$}\NormalTok{Symbol)}
\ControlFlowTok{if}\NormalTok{(}\KeywordTok{sum}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(genes\_ndx))) }\KeywordTok{stop}\NormalTok{(}\StringTok{"hcc5hmC\_F\_voom\_efit/hcc5hmC\_genes\_annot\_F: genes mismatch"}\NormalTok{)}
\NormalTok{GC\_vec <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(hcc5hmC\_genes\_annot\_F[genes\_ndx,],(G}\OperatorTok{+}\NormalTok{C)}\OperatorTok{/}\NormalTok{(A}\OperatorTok{+}\NormalTok{C}\OperatorTok{+}\NormalTok{G}\OperatorTok{+}\NormalTok{T))}
...
\begin{figure}
\centering
\includegraphics{Static/figures/hcc5hmC-preproc-mdPlotEfit-1.pdf}
\caption{\label{fig:hcc5hmC-preproc-mdPlotEfit}HCC vs Control - Genes Identified at FDR = 0,05}
\end{figure}
...
\NormalTok{hcc5hmC\_featureCounts\_F\_logFC\_sum <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(}
...
\KeywordTok{colnames}\NormalTok{(hcc5hmC\_featureCounts\_F\_logFC\_sum) <{-}}\StringTok{ }\KeywordTok{as.character}\NormalTok{(}\KeywordTok{factor}\NormalTok{(}
 \KeywordTok{colnames}\NormalTok{(hcc5hmC\_featureCounts\_F\_logFC\_sum), }
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(hcc5hmC\_featureCounts\_F\_logFC\_sum,}
...
\caption{\label{tab:hcc5hmC-preproc-quantlogFC}log FC quartiles by gene identification}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
  & down & notDE & up\\
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(hcc5hmC\_F\_voom\_tfit\_dt)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{limma}\OperatorTok{::}\KeywordTok{plotMD}\NormalTok{(hcc5hmC\_F\_voom\_efit,}
 ...
 \DataTypeTok{column=}\StringTok{\textquotesingle{}HCCvsControl\textquotesingle{}}\NormalTok{,}
 \DataTypeTok{status=}\NormalTok{hcc5hmC\_F\_voom\_tfit\_dt[,}\StringTok{\textquotesingle{}HCCvsControl\textquotesingle{}}\NormalTok{],}
...
\begin{Highlighting}[]
\CommentTok{\#\#\#\# CLEAR CACHE}
\NormalTok{lib.size <{-}}\StringTok{ }\KeywordTok{colSums}\NormalTok{(hcc5hmC\_F\_dgel}\OperatorTok{$}\NormalTok{counts)}

\NormalTok{fit <{-}}\StringTok{ }\NormalTok{hcc5hmC\_F\_voom\_efit}
...
\NormalTok{Effect <{-}}\StringTok{ }\KeywordTok{abs}\NormalTok{(hcc5hmC\_F\_voom\_efit}\OperatorTok{$}\NormalTok{coefficients[,}\StringTok{\textquotesingle{}HCCvsControl\textquotesingle{}}\NormalTok{])}
\NormalTok{Noise <{-}}\StringTok{ }\NormalTok{hcc5hmC\_F\_voom\_efit}\OperatorTok{$}\NormalTok{sigma}
...
\begin{figure}
\centering
\includegraphics{Static/figures/hcc5hmC-preproc-plotSNR-1.pdf}
\caption{\label{fig:hcc5hmC-preproc-plotSNR}Cumulative Distribution of SNR - rug = 25, 50, 75 and 90th percentile}
\end{figure}
...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{hcc5hmC\_train\_sampID\_vec <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(hcc5hmC\_F\_dgel}\OperatorTok{$}\NormalTok{samples,}
\NormalTok{hcc5hmC\_F\_dgel}\OperatorTok{$}\NormalTok{samples}\OperatorTok{$}\NormalTok{sampID[caret}\OperatorTok{::}\KeywordTok{createDataPartition}\NormalTok{(}\DataTypeTok{y=}\NormalTok{group, }\DataTypeTok{p=}\NormalTok{trainP, }\DataTypeTok{list=}\NormalTok{F)]}
\NormalTok{)}

\NormalTok{hcc5hmC\_test\_sampID\_vec <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(hcc5hmC\_F\_dgel}\OperatorTok{$}\NormalTok{samples,}
\KeywordTok{setdiff}\NormalTok{(sampID, hcc5hmC\_train\_sampID\_vec)}
\NormalTok{)}

\NormalTok{hcc5hmC\_train\_group\_vec <{-}}\StringTok{ }\NormalTok{hcc5hmC\_F\_dgel}\OperatorTok{$}\NormalTok{samples[hcc5hmC\_train\_sampID\_vec, }\StringTok{\textquotesingle{}group\textquotesingle{}}\NormalTok{]}
\KeywordTok{names}\NormalTok{(hcc5hmC\_train\_group\_vec) <{-}}\StringTok{ }\NormalTok{hcc5hmC\_F\_dgel}\OperatorTok{$}\NormalTok{samples[hcc5hmC\_train\_sampID\_vec, }\StringTok{\textquotesingle{}sampID\textquotesingle{}}\NormalTok{]}

\NormalTok{hcc5hmC\_test\_group\_vec <{-}}\StringTok{ }\NormalTok{hcc5hmC\_F\_dgel}\OperatorTok{$}\NormalTok{samples[hcc5hmC\_test\_sampID\_vec, }\StringTok{\textquotesingle{}group\textquotesingle{}}\NormalTok{]}
\KeywordTok{names}\NormalTok{(hcc5hmC\_test\_group\_vec) <{-}}\StringTok{ }\NormalTok{hcc5hmC\_F\_dgel}\OperatorTok{$}\NormalTok{samples[hcc5hmC\_test\_sampID\_vec, }\StringTok{\textquotesingle{}sampID\textquotesingle{}}\NormalTok{]}

\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{table}\NormalTok{(hcc5hmC\_train\_group\_vec),}
...
\caption{\label{tab:hcc5hmC-glmnetFit-getTrainVal}Train set}
\centering
\begin{tabular}[t]{l|r}
\hline
hcc5hmC\_train\_group\_vec & Freq\\
\hline
Control & 623\\
\hline
HCC & 444\\
...
\NormalTok{ train\_oofPred\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(train\_oofPred\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_train\_group\_vec)}
...
\NormalTok{ train\_oofPred\_min\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(train\_oofPred\_min\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_train\_group\_vec)}
...
\NormalTok{ )}
\NormalTok{ test\_pred\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(test\_pred\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_test\_group\_vec)}
...
\NormalTok{  cv\_fit, }
  ...
  \DataTypeTok{type=}\StringTok{"class"}
\NormalTok{ )}
\NormalTok{ test\_pred\_min\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(test\_pred\_min\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_test\_group\_vec)}
...
\NormalTok{ lasso\_errors\_mtx <{-}}\StringTok{ }\KeywordTok{plot\_cv\_f}\NormalTok{(hcc5hmC\_cv\_lasso, }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{5}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ rifge\_errors\_mtx <{-}}\StringTok{ }\KeywordTok{plot\_cv\_f}\NormalTok{(hcc5hmC\_cv\_ridge, }\DataTypeTok{Nzero=}\NormalTok{F, }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{5}\NormalTok{))}
 \KeywordTok{title}\NormalTok{(}\StringTok{\textquotesingle{}ridge\textquotesingle{}}\NormalTok{)}

\NormalTok{ enet\_errors\_mtx <{-}}\StringTok{  }\KeywordTok{plot\_cv\_f}\NormalTok{(hcc5hmC\_cv\_enet, }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{5}\NormalTok{))}
 ...
 \KeywordTok{mtext}\NormalTok{(}\DataTypeTok{side=}\DecValTok{2}\NormalTok{, }\DataTypeTok{outer=}\NormalTok{T, }\DataTypeTok{cex=}\FloatTok{1.25}\NormalTok{, hcc5hmC\_cv\_lasso}\OperatorTok{$}\NormalTok{name)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se, hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{ndx\_min <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda.min, hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda)}
...
\NormalTok{train\_oofPred\_relaxed\_1se\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
  \KeywordTok{logistic\_f}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{"g:0"}\NormalTok{]][, ndx\_1se]) }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{"HCC"}\NormalTok{, }\StringTok{"Control"}
\NormalTok{)}
\NormalTok{train\_oofPred\_relaxed\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(train\_oofPred\_relaxed\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_train\_group\_vec)}

\CommentTok{\# blended mix (gamma=0.5)}
\NormalTok{train\_oofPred\_blended\_1se\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
  \KeywordTok{logistic\_f}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{"g:0.5"}\NormalTok{]][, ndx\_1se]) }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{"HCC"}\NormalTok{, }\StringTok{"Control"}
\NormalTok{)}
\NormalTok{train\_oofPred\_blended\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(train\_oofPred\_blended\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_train\_group\_vec)}
...
\NormalTok{)}
\NormalTok{test\_pred\_relaxed\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(test\_pred\_relaxed\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_test\_group\_vec)}
...
\NormalTok{)}
\NormalTok{test\_pred\_blended\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(test\_pred\_blended\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_test\_group\_vec)}


\NormalTok{hcc5hmC\_cv\_lassoR\_1se\_error <{-}}\StringTok{ }\NormalTok{hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{cvm[hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda}\OperatorTok{==}\NormalTok{hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda.min]}

\NormalTok{cv\_blended\_statlist <{-}}\StringTok{ }\NormalTok{hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{relaxed}\OperatorTok{$}\NormalTok{statlist[[}\StringTok{\textquotesingle{}g:0.5\textquotesingle{}}\NormalTok{]]}
...
\StringTok{   }\NormalTok{hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{relaxed}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se]}
 


\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{t}\NormalTok{(}\KeywordTok{data.frame}\NormalTok{(}
  \DataTypeTok{train\_relaxed  =}\NormalTok{ hcc5hmC\_cv\_lassoR\_1se\_error,}
...
\CommentTok{\# train}
\CommentTok{\# lasso}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(hcc5hmC\_cv\_lasso}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,hcc5hmC\_cv\_lasso}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_lasso\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(hcc5hmC\_cv\_lasso}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_1se])}
\NormalTok{train\_lasso\_roc <{-}}\StringTok{ }\NormalTok{pROC}\OperatorTok{::}\KeywordTok{roc}\NormalTok{(}
 \DataTypeTok{response =} \KeywordTok{as.numeric}\NormalTok{(hcc5hmC\_train\_group\_vec}\OperatorTok{==}\StringTok{\textquotesingle{}HCC\textquotesingle{}}\NormalTok{),}
...
\begin{Highlighting}[]
\CommentTok{\# enet}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(hcc5hmC\_cv\_enet}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,hcc5hmC\_cv\_enet}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_enet\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(hcc5hmC\_cv\_enet}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_1se])}
...
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_relaxed\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{\textquotesingle{}g:0\textquotesingle{}}\NormalTok{]][,ndx\_1se])}
...
\CommentTok{\# blended mix (gamma=0.5)}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_blended\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{\textquotesingle{}g:0.5\textquotesingle{}}\NormalTok{]][,ndx\_1se])}
...
\NormalTok{  tmp <{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}
    \DataTypeTok{train =} \KeywordTok{split}\NormalTok{(train\_1se\_predProb\_vec, hcc5hmC\_train\_group\_vec),}
    \DataTypeTok{test =} \KeywordTok{split}\NormalTok{(test\_1se\_predProb\_vec, hcc5hmC\_test\_group\_vec)}
\NormalTok{  )}
...
\CommentTok{\# RECALL: hcc5hmC\_cv\_lassoR$nzero[hcc5hmC\_cv\_lassoR$lambda==hcc5hmC\_cv\_lassoR$lambda.1se]}
\CommentTok{\# train {-} oof}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_relaxed\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{\textquotesingle{}g:0\textquotesingle{}}\NormalTok{]][,ndx\_1se])}
...
\CommentTok{\# RECALL $\textasciigrave{}r hcc5hmC\_cv\_lassoR$relaxed$nzero.1se\textasciigrave{}$ features (vertical}
\CommentTok{\#  cv\_blended\_statlist <{-} hcc5hmC\_cv\_lassoR$relaxed$statlist[[\textquotesingle{}g:0.5\textquotesingle{}]]}
\CommentTok{\#  cv\_blended\_1se\_error <{-} cv\_blended\_statlist$cvm[cv\_blended\_statlist$lambda==}
      \CommentTok{\#hcc5hmC\_cv\_lassoR$relaxed$lambda.1se]}

\CommentTok{\# train {-} oof}
\NormalTok{cv\_blended\_statlist <{-}}\StringTok{ }\NormalTok{hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{relaxed}\OperatorTok{$}\NormalTok{statlist[[}\StringTok{\textquotesingle{}g:0.5\textquotesingle{}}\NormalTok{]]}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{relaxed}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se, cv\_blended\_statlist}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_blended\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(hcc5hmC\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{\textquotesingle{}g:0.5\textquotesingle{}}\NormalTok{]][,ndx\_1se])}
...
\NormalTok{misclass\_id\_vec <{-}}\StringTok{ }\KeywordTok{unique}\NormalTok{(}\KeywordTok{c}\NormalTok{(}
 \KeywordTok{names}\NormalTok{(train\_lasso\_oofClass\_vec)[train\_lasso\_oofClass\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_train\_group\_vec],}
 \KeywordTok{names}\NormalTok{(train\_enet\_oofClass\_vec)[train\_enet\_oofClass\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_train\_group\_vec],}
 \KeywordTok{names}\NormalTok{(train\_relaxed\_oofClass\_vec)[train\_relaxed\_oofClass\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_train\_group\_vec],}
 \KeywordTok{names}\NormalTok{(train\_blended\_oofClass\_vec)[train\_blended\_oofClass\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{hcc5hmC\_train\_group\_vec]}
\NormalTok{ )}
\NormalTok{)}
...
\NormalTok{  Mycol <{-}}\StringTok{ }\KeywordTok{colorpanel}\NormalTok{(}\DecValTok{1000}\NormalTok{, }\StringTok{"blue"}\NormalTok{, }\StringTok{"red"}\NormalTok{)}
  \KeywordTok{heatmap.2}\NormalTok{(}
    \DataTypeTok{x=}\KeywordTok{t}\NormalTok{(hcc5hmC\_train\_lcpm\_mtx[,lasso\_coef\_frm}\OperatorTok{$}\NormalTok{gene[}\OperatorTok{{-}}\DecValTok{1}\NormalTok{]]),}
    \DataTypeTok{scale=}\StringTok{"row"}\NormalTok{,}
    \DataTypeTok{labRow=}\NormalTok{lasso\_coef\_frm}\OperatorTok{$}\NormalTok{gene,}
    \DataTypeTok{labCol=}\NormalTok{hcc5hmC\_train\_group\_vec,}
    ...
    \DataTypeTok{ColSideColors=}\KeywordTok{ifelse}\NormalTok{(hcc5hmC\_train\_group\_vec}\OperatorTok{==}\StringTok{\textquotesingle{}Control\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}green\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}red\textquotesingle{}}\NormalTok{),}
...
\NormalTok{  Mycol <{-}}\StringTok{ }\KeywordTok{colorpanel}\NormalTok{(}\DecValTok{1000}\NormalTok{, }\StringTok{"blue"}\NormalTok{, }\StringTok{"red"}\NormalTok{)}
  \KeywordTok{heatmap.2}\NormalTok{(}
    \DataTypeTok{x=}\KeywordTok{t}\NormalTok{(hcc5hmC\_train\_lcpm\_mtx[,enet\_coef\_frm}\OperatorTok{$}\NormalTok{gene[}\OperatorTok{{-}}\DecValTok{1}\NormalTok{]]),}
    \DataTypeTok{scale=}\StringTok{"row"}\NormalTok{,}
...
\CommentTok{\#\#\# CLEAR CACHE}
\KeywordTok{plot}\NormalTok{(}
 \KeywordTok{log}\NormalTok{(hcc5hmC\_cv\_lassoAll\_lst[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{lambda),}
\NormalTok{ hcc5hmC\_cv\_lassoAll\_lst[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{cvm,}
...
\ControlFlowTok{for}\NormalTok{(JJ }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\KeywordTok{length}\NormalTok{(hcc5hmC\_cv\_lassoAll\_lst))}
 \KeywordTok{lines}\NormalTok{(}
  \KeywordTok{log}\NormalTok{(hcc5hmC\_cv\_lassoAll\_lst[[JJ]]}\OperatorTok{$}\NormalTok{lambda),}
\NormalTok{  hcc5hmC\_cv\_lassoAll\_lst[[JJ]]}\OperatorTok{$}\NormalTok{cvm,}
...
\CommentTok{\# nzero}
\NormalTok{nzero\_1se\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_lassoAll\_lst,}
...
\NormalTok{nzero\_min\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_lassoAll\_lst,}
...
\CommentTok{\# error}
\NormalTok{error\_1se\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_lassoAll\_lst,}
...
\NormalTok{error\_min\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_lassoAll\_lst,}
...
\KeywordTok{boxplot}\NormalTok{(}
 ...
 \DataTypeTok{ylab=}\NormalTok{hcc5hmC\_cv\_lassoAll\_lst[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{name,}
...
\NormalTok{lassoAll\_predResp\_1se\_mtx <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_lassoAll\_lst, }\ControlFlowTok{function}\NormalTok{(cv\_fit) \{ }
\NormalTok{  ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,cv\_fit}\OperatorTok{$}\NormalTok{lambda)}
...
\NormalTok{lassoAll\_predResp\_min\_mtx <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_lassoAll\_lst, }\ControlFlowTok{function}\NormalTok{(cv\_fit) \{ }
\NormalTok{  ndx\_min <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{lambda.min,cv\_fit}\OperatorTok{$}\NormalTok{lambda)}
...
\NormalTok{tmp <{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}
 \StringTok{\textasciigrave{}}\DataTypeTok{1se}\StringTok{\textasciigrave{}}\NormalTok{ =}\StringTok{ }\KeywordTok{split}\NormalTok{(lassoAll\_predResp\_1se\_vec, hcc5hmC\_all\_group\_vec),}
 \DataTypeTok{min =} \KeywordTok{split}\NormalTok{(lassoAll\_predResp\_min\_vec, hcc5hmC\_all\_group\_vec)}
\NormalTok{)}
...
\addcontentsline{toc}{subsection}{Get sample consistency scores}
...
\NormalTok{       cv\_fit,}
       ...
       \DataTypeTok{type=}\StringTok{"class"}
\NormalTok{      )}
\NormalTok{      test\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(test\_pred\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{sim\_stage\_hcc5hmC\_test\_group\_vec)}
...
\ControlFlowTok{for}\NormalTok{(SIM }\ControlFlowTok{in} \KeywordTok{unique}\NormalTok{(hcc5hmC\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{SimNo)[}\DecValTok{1}\NormalTok{])\{}
...
\CommentTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
\CommentTok{\#\# cv}
\NormalTok{cv\_1se\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(hcc5hmC\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{hcc5hmC\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
...
\NormalTok{ stringr}\OperatorTok{::}\KeywordTok{str\_pad}\NormalTok{(}\KeywordTok{unique}\NormalTok{(hcc5hmC\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size), }\DataTypeTok{width=}\DecValTok{3}\NormalTok{, }\DataTypeTok{pad=}\StringTok{\textquotesingle{}0\textquotesingle{}}\NormalTok{), }\StringTok{\textquotesingle{}\_cv\textquotesingle{}}\NormalTok{)}

\CommentTok{\#\# test}
\NormalTok{test\_1se\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(hcc5hmC\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{hcc5hmC\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
...
\CommentTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
\CommentTok{\#\# cv}
\NormalTok{cv\_min\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(hcc5hmC\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{hcc5hmC\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
...
\CommentTok{\#\# test}
\NormalTok{test\_min\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(hcc5hmC\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{hcc5hmC\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
...
\NormalTok{p\_1se\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(hcc5hmC\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{hcc5hmC\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
...
\NormalTok{sign\_p\_1se\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(hcc5hmC\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{hcc5hmC\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
...
\KeywordTok{points}\NormalTok{(}
   ...
   \DataTypeTok{y=}\NormalTok{p\_singP\_1se\_Bysize\_lst[[JJ]], }\DataTypeTok{cex=}\FloatTok{0.5}\NormalTok{,}
...
\KeywordTok{legend}\NormalTok{(}\StringTok{\textquotesingle{}topleft\textquotesingle{}}\NormalTok{,}
   ...
   \DataTypeTok{bty=}\StringTok{\textquotesingle{}n\textquotesingle{}}
\NormalTok{ )}
\KeywordTok{title}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}one se lamdba models\textquotesingle{}}\NormalTok{))}


\CommentTok{\# min}
\CommentTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
\CommentTok{\# selected features}
\NormalTok{p\_min\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(hcc5hmC\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{hcc5hmC\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
...
\CommentTok{\# selected signatue features}
\NormalTok{sign\_p\_min\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(hcc5hmC\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{hcc5hmC\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
...
\begin{Highlighting}[]
\CommentTok{\#\#\# CLEAR CACHE}
\ControlFlowTok{if}\NormalTok{ (}\OperatorTok{!}\NormalTok{(}\StringTok{"GSE96058"} \OperatorTok{\%in\%}\StringTok{ }\KeywordTok{rownames}\NormalTok{(}\KeywordTok{installed.packages}\NormalTok{()))) \{}
  \ControlFlowTok{if}\NormalTok{ (}\OperatorTok{!}\KeywordTok{requireNamespace}\NormalTok{(}\StringTok{"devtools"}\NormalTok{, }\DataTypeTok{quietly =} \OtherTok{TRUE}\NormalTok{)) \{}
    \KeywordTok{install.packages}\NormalTok{(}\StringTok{"devtools"}\NormalTok{)}
\NormalTok{  \}}
\NormalTok{  devtools}\OperatorTok{::}\KeywordTok{install\_github}\NormalTok{(}\StringTok{"12379Monty/GSE96058"}\NormalTok{)}
\NormalTok{\}}

\KeywordTok{library}\NormalTok{(GSE96058)}

\CommentTok{\# Strip GSE\_ID prefix form object names}
\CommentTok{\#\#\# MOD: (2020.09.21) keep \textquotesingle{}brcaRna\_\textquotesingle{} as prefix to object names.}
\CommentTok{\#\#\#     Otherwise we run into problems when different datasets are}
\CommentTok{\#\#\#     analyzed}

\ControlFlowTok{for}\NormalTok{(OBJ }\ControlFlowTok{in} \KeywordTok{data}\NormalTok{(}\DataTypeTok{package=}\StringTok{\textquotesingle{}GSE96058\textquotesingle{}}\NormalTok{)}\OperatorTok{$}\NormalTok{results[, }\StringTok{\textquotesingle{}Item\textquotesingle{}}\NormalTok{])}
\KeywordTok{assign}\NormalTok{(}\KeywordTok{sub}\NormalTok{(}\StringTok{\textquotesingle{}GSE96058\_\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}brcaRna\_\textquotesingle{}}\NormalTok{,OBJ), }\KeywordTok{get}\NormalTok{(OBJ))}

\KeywordTok{detach}\NormalTok{(package}\OperatorTok{:}\NormalTok{GSE96058, }\DataTypeTok{unload =}\NormalTok{ T )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ER\_HER2\_tbl <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(brcaRna\_sampDesc }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\KeywordTok{grepl}\NormalTok{(}\StringTok{\textquotesingle{}repl$\textquotesingle{}}\NormalTok{, title) }\OperatorTok{\&}\StringTok{ }\OperatorTok{!}\NormalTok{isRepl }\OperatorTok{\&}\StringTok{ }\NormalTok{er\_Status}\OperatorTok{!=}\StringTok{\textquotesingle{}NA\textquotesingle{}}   \OperatorTok{\&}\StringTok{ }\NormalTok{her2\_Status}\OperatorTok{!=}\StringTok{\textquotesingle{}NA\textquotesingle{}}\NormalTok{),}
 \KeywordTok{table}\NormalTok{(}\DataTypeTok{ER\_HER2=}\KeywordTok{paste}\NormalTok{(er\_Status, her2\_Status, }\DataTypeTok{sep=}\StringTok{\textquotesingle{}\_\textquotesingle{}}\NormalTok{),}
  \DataTypeTok{exclude=}\OtherTok{NULL}\NormalTok{)}
\NormalTok{ )}

\NormalTok{ knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(ER\_HER2\_tbl,}
  \DataTypeTok{caption=}\StringTok{"ER, PR and HER2 Status"}\NormalTok{)  }\OperatorTok{\%>\%}
\StringTok{  }\NormalTok{kableExtra}\OperatorTok{::}\KeywordTok{kable\_styling}\NormalTok{(}\DataTypeTok{full\_width =}\NormalTok{ F)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\# Subset analysis samples}
\NormalTok{brcaRna\_sampDesc <{-}}
\StringTok{  }\NormalTok{brcaRna\_sampDesc }\OperatorTok{\%>\%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\KeywordTok{grepl}\NormalTok{(}\StringTok{\textquotesingle{}repl$\textquotesingle{}}\NormalTok{, title) }\OperatorTok{\&}\StringTok{ }\NormalTok{er\_Status }\OperatorTok{==}\StringTok{ \textquotesingle{}1\textquotesingle{}} \OperatorTok{\&}\StringTok{ }\NormalTok{her2\_Status }\OperatorTok{==}\StringTok{ \textquotesingle{}0\textquotesingle{}}\NormalTok{) }\OperatorTok{\%>\%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{group =}\NormalTok{ pam50\_subtype) }\OperatorTok{\%>\%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{rename}\NormalTok{(}\DataTypeTok{sampID =}\NormalTok{ title) }\OperatorTok{\%>\%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{arrange}\NormalTok{(group, sampID)}

\CommentTok{\#with(brcaRna\_sampDesc, table(group, exclude=NULL))}

\CommentTok{\# Recode group}
\NormalTok{brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{group <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(}
\NormalTok{  brcaRna\_sampDesc,}
  \KeywordTok{ifelse}\NormalTok{(group }\OperatorTok{==}\StringTok{ "LumA"}\NormalTok{, }\StringTok{"LumA"}\NormalTok{, }\StringTok{"Other"}\NormalTok{)  }\CommentTok{\#\# Luma > Other}
\NormalTok{)}

\CommentTok{\# Re{-}order and name rows}
\NormalTok{o.v <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(brcaRna\_sampDesc, }\KeywordTok{order}\NormalTok{(group, sampID))}
\NormalTok{brcaRna\_sampDesc  <{-}}\StringTok{ }\NormalTok{brcaRna\_sampDesc[o.v, ]}

\KeywordTok{rownames}\NormalTok{(brcaRna\_sampDesc) <{-}}\StringTok{ }\NormalTok{brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{sampID}

\CommentTok{\# set brcaRna\_groupCol for later}
\NormalTok{brcaRna\_groupCol <{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"\#F3C300"}\NormalTok{, }\StringTok{"\#875692"}\NormalTok{)}
\KeywordTok{names}\NormalTok{(brcaRna\_groupCol) <{-}}\StringTok{ }\KeywordTok{unique}\NormalTok{(brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{group)}

\KeywordTok{with}\NormalTok{(brcaRna\_sampDesc, }
\NormalTok{ knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{table}\NormalTok{(group, }\DataTypeTok{exclude =} \OtherTok{NULL}\NormalTok{),}
  \DataTypeTok{caption=}\StringTok{"Samples used in this analysis"}\NormalTok{) }\OperatorTok{\%>\%}
\StringTok{  }\NormalTok{kableExtra}\OperatorTok{::}\KeywordTok{kable\_styling}\NormalTok{(}\DataTypeTok{full\_width =}\NormalTok{ F)}
\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Start for geneExpression\_repl1 data}
\NormalTok{repl1\_ndx <{-}}\StringTok{ }\KeywordTok{which}\NormalTok{(}\KeywordTok{is.element}\NormalTok{(}\KeywordTok{colnames}\NormalTok{(brcaRna\_geneExpression\_repl1), brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{sampID))}
\NormalTok{brcaRna\_geneExpression <{-}}\StringTok{ }\NormalTok{brcaRna\_geneExpression\_repl1[, repl1\_ndx]}

\CommentTok{\# add samples from brcaRna\_geneExpression\_subJJ}
\ControlFlowTok{for}\NormalTok{(JJ }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{) \{}
\NormalTok{  sub\_ndx <{-}}\StringTok{ }\KeywordTok{which}\NormalTok{(}\KeywordTok{is.element}\NormalTok{(}
   \KeywordTok{colnames}\NormalTok{(}\KeywordTok{get}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}brcaRna\_geneExpression\_sub\textquotesingle{}}\NormalTok{,JJ))),  brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{sampID))}
\NormalTok{  brcaRna\_geneExpression <{-}}\StringTok{ }\KeywordTok{cbind}\NormalTok{(brcaRna\_geneExpression,}
   \KeywordTok{get}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}brcaRna\_geneExpression\_sub\textquotesingle{}}\NormalTok{,JJ))[, sub\_ndx])}
\NormalTok{\}}

\CommentTok{\# align brcaRna\_geneExpression columns to brcaRna\_sampDesc samples order}
\NormalTok{geneExpr\_ndx <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{sampID, }\KeywordTok{colnames}\NormalTok{(brcaRna\_geneExpression))}
\ControlFlowTok{if}\NormalTok{(}\KeywordTok{any}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(geneExpr\_ndx)))}
\KeywordTok{stop}\NormalTok{(}\StringTok{"brcaRna\_sampDesc/brcaRna\_geneExpression: sample mismatch"}\NormalTok{) }\ControlFlowTok{else}
\NormalTok{brcaRna\_geneExpression <{-}}\StringTok{ }\NormalTok{brcaRna\_geneExpression[, }\KeywordTok{rownames}\NormalTok{(brcaRna\_sampDesc)]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mar =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{))}
\KeywordTok{boxplot}\NormalTok{(brcaRna\_geneExpression,}
  \DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\OperatorTok{{-}}\DecValTok{4}\NormalTok{, }\DecValTok{4}\NormalTok{), }\DataTypeTok{ylab=}\StringTok{\textquotesingle{}log2 Count\textquotesingle{}}\NormalTok{,}
  \DataTypeTok{staplewex =} \DecValTok{0}\NormalTok{,       }\CommentTok{\# remove horizontal whisker lines}
  \DataTypeTok{staplecol =} \StringTok{"white"}\NormalTok{, }\CommentTok{\# just to be totally sure :)}
  \DataTypeTok{outline =}\NormalTok{ F,         }\CommentTok{\# remove outlying points}
  \DataTypeTok{whisklty =} \DecValTok{0}\NormalTok{,        }\CommentTok{\# remove vertical whisker lines}
  \DataTypeTok{las =} \DecValTok{2}\NormalTok{, }\DataTypeTok{horizontal =}\NormalTok{ F, }\DataTypeTok{xaxt =} \StringTok{"n"}\NormalTok{,}
  \DataTypeTok{border =}\NormalTok{ brcaRna\_groupCol[brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{group]}
\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"top"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{names}\NormalTok{(brcaRna\_groupCol), }\DataTypeTok{text.col =}\NormalTok{ brcaRna\_groupCol, }
  \DataTypeTok{ncol =} \DecValTok{2}\NormalTok{, }\DataTypeTok{bty =} \StringTok{"n"}\NormalTok{)}
\CommentTok{\# Add reference lines}
\NormalTok{SampleMedian <{-}}\StringTok{ }\KeywordTok{apply}\NormalTok{(brcaRna\_geneExpression, }\DecValTok{2}\NormalTok{, median)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{h =} \KeywordTok{median}\NormalTok{(SampleMedian), }\DataTypeTok{col =} \StringTok{"grey"}\NormalTok{)}
\KeywordTok{axis}\NormalTok{(}\DataTypeTok{side =} \DecValTok{4}\NormalTok{, }\DataTypeTok{at =} \KeywordTok{round}\NormalTok{(}\KeywordTok{median}\NormalTok{(SampleMedian), }\DecValTok{2}\NormalTok{), }
  \DataTypeTok{las =} \DecValTok{2}\NormalTok{, }\DataTypeTok{col =} \StringTok{"grey"}\NormalTok{, }\DataTypeTok{line =} \DecValTok{0}\NormalTok{, }\DataTypeTok{tick =}\NormalTok{ F)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\includegraphics{Static/figures/brcaRna-preproc-geneExprBxp-1.pdf}
\caption{\label{fig:brcaRna-preproc-geneExprBxp}Sample log2 count boxplots}
\end{figure}
...
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mar =} \KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(}\KeywordTok{density}\NormalTok{(brcaRna\_geneExpression[, }\DecValTok{1}\NormalTok{]), }
  \DataTypeTok{col =}\NormalTok{ brcaRna\_groupCol[brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{group[}\DecValTok{1}\NormalTok{]], }\DataTypeTok{lwd =} \DecValTok{2}\NormalTok{, }
  \DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{.30}\NormalTok{), }\DataTypeTok{xlim=}\KeywordTok{c}\NormalTok{(}\OperatorTok{{-}}\DecValTok{5}\NormalTok{, }\DecValTok{10}\NormalTok{),}
  \DataTypeTok{las =} \DecValTok{2}\NormalTok{, }\DataTypeTok{main =} \StringTok{""}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"gene expression"}
\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{v =} \DecValTok{0}\NormalTok{, }\DataTypeTok{col =} \DecValTok{3}\NormalTok{)}
\CommentTok{\# After verifying no outliers, can plot a random subset }
\ControlFlowTok{for}\NormalTok{ (JJ }\ControlFlowTok{in} \KeywordTok{sample}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(brcaRna\_geneExpression), }\DataTypeTok{size =} \DecValTok{100}\NormalTok{)) \{}
\NormalTok{  den <{-}}\StringTok{ }\KeywordTok{density}\NormalTok{(brcaRna\_geneExpression[, JJ])}
  \KeywordTok{lines}\NormalTok{(den}\OperatorTok{$}\NormalTok{x, den}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{col =}\NormalTok{ brcaRna\_groupCol[brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{group[JJ]], }\DataTypeTok{lwd =} \DecValTok{2}\NormalTok{)}
\NormalTok{\} }\CommentTok{\# for(JJ}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{names}\NormalTok{(brcaRna\_groupCol), }
  \DataTypeTok{text.col =}\NormalTok{ brcaRna\_groupCol, }\DataTypeTok{bty =} \StringTok{"n"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\includegraphics{Static/figures/brcaRna-preproc-densityGeneExpr-1.pdf}
\caption{\label{fig:brcaRna-preproc-densityGeneExpr}Sample gene expression densities}
\end{figure}

In this analysis we will be using a nominal gene expression value of
0, genes are deeemed to be \texttt{represented} if their expression is
above this threshold, and not represented otherwise.
For this analysis we will require that genes be \texttt{represented} in at least
25 samples across the entire dataset to be retained for downstream analysis.
...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mar =} \KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(}\KeywordTok{density}\NormalTok{(brcaRna\_geneExpression\_F[, }\DecValTok{1}\NormalTok{]),}
  \DataTypeTok{col =}\NormalTok{ brcaRna\_groupCol[brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{group[}\DecValTok{1}\NormalTok{]],}
  \DataTypeTok{lwd =} \DecValTok{2}\NormalTok{, }\DataTypeTok{las =} \DecValTok{2}\NormalTok{, }\DataTypeTok{main =} \StringTok{""}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"gene expression"}\NormalTok{,}
  \DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{.30}\NormalTok{), }\DataTypeTok{xlim=}\KeywordTok{c}\NormalTok{(}\OperatorTok{{-}}\DecValTok{5}\NormalTok{, }\DecValTok{10}\NormalTok{)}
\NormalTok{)}
\CommentTok{\#abline(v = 0, col = 3)}
\CommentTok{\# After verifying no outliers, can plot a random subset }
\ControlFlowTok{for}\NormalTok{ (JJ }\ControlFlowTok{in} \KeywordTok{sample}\NormalTok{(}\DecValTok{2}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(brcaRna\_geneExpression\_F), }\DataTypeTok{size =} \DecValTok{100}\NormalTok{)) \{}
\NormalTok{  den <{-}}\StringTok{ }\KeywordTok{density}\NormalTok{(brcaRna\_geneExpression\_F[, JJ])}
  \KeywordTok{lines}\NormalTok{(den}\OperatorTok{$}\NormalTok{x, den}\OperatorTok{$}\NormalTok{y, }\DataTypeTok{col =}\NormalTok{ brcaRna\_groupCol[brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{group[JJ]], }\DataTypeTok{lwd =} \DecValTok{2}\NormalTok{)}
\NormalTok{\} }\CommentTok{\# for(JJ}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{, }\DataTypeTok{legend =} \KeywordTok{names}\NormalTok{(brcaRna\_groupCol), }
  \DataTypeTok{text.col =}\NormalTok{ brcaRna\_groupCol, }\DataTypeTok{bty =} \StringTok{"n"}\NormalTok{)}
...
\CommentTok{\# remove from final version}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{samp\_ndx <{-}}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{ncol}\NormalTok{(brcaRna\_geneExpression\_F), }\DataTypeTok{size =} \DecValTok{500}\NormalTok{)}
\NormalTok{MDS.out <{-}}\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{plotMDS}\NormalTok{(brcaRna\_geneExpression\_F[, samp\_ndx],}
  \DataTypeTok{col =}\NormalTok{ brcaRna\_groupCol[brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{group[samp\_ndx]], }\DataTypeTok{pch =} \DecValTok{1}
\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{,}
  \DataTypeTok{legend =} \KeywordTok{names}\NormalTok{(brcaRna\_groupCol),}
  \DataTypeTok{text.col =}\NormalTok{ brcaRna\_groupCol, }\DataTypeTok{bty =} \StringTok{"n"}
\NormalTok{)}

\NormalTok{MDS.out <{-}}\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{plotMDS}\NormalTok{(brcaRna\_geneExpression\_F[, samp\_ndx],}
  \DataTypeTok{col =}\NormalTok{ brcaRna\_groupCol[brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{group[samp\_ndx]], }\DataTypeTok{pch =} \DecValTok{1}\NormalTok{,}
  \DataTypeTok{dim.plot =} \DecValTok{3}\OperatorTok{:}\DecValTok{4}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{Static/figures/brcaRna-preproc-plotMDS-1.pdf}
\caption{\label{fig:brcaRna-preproc-plotMDS}MDS plots of gene expression values}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ brcaRna\_geneExpression\_F\_fit <{-}}\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{lmFit}\NormalTok{(brcaRna\_geneExpression\_F, Design\_mtx)}
 \KeywordTok{colnames}\NormalTok{(brcaRna\_geneExpression\_F\_fit}\OperatorTok{$}\NormalTok{coefficients) <{-}}\StringTok{ }\KeywordTok{sub}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{(Intercept}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{)"}\NormalTok{, }\StringTok{"Intercept"}\NormalTok{,}
 \KeywordTok{colnames}\NormalTok{(brcaRna\_geneExpression\_F\_fit}\OperatorTok{$}\NormalTok{coefficients) )}

\NormalTok{ brcaRna\_geneExpression\_F\_fit <{-}}\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{contrasts.fit}\NormalTok{(}
\NormalTok{    brcaRna\_geneExpression\_F\_fit, }\DataTypeTok{contrasts=}\NormalTok{Contrasts\_mtx)}

\NormalTok{ brcaRna\_geneExpression\_F\_efit <{-}}\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{eBayes}\NormalTok{(brcaRna\_geneExpression\_F\_fit)}

\NormalTok{ brcaRna\_geneExpression\_F\_efit\_dt <{-}}
\StringTok{ }\NormalTok{limma}\OperatorTok{::}\KeywordTok{decideTests}\NormalTok{(brcaRna\_geneExpression\_F\_efit,}\DataTypeTok{adjust.method =} \StringTok{"BH"}\NormalTok{, }\DataTypeTok{p.value =} \FloatTok{0.05}\NormalTok{)}
 
\NormalTok{ knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{t}\NormalTok{(}\KeywordTok{summary}\NormalTok{(brcaRna\_geneExpression\_F\_efit\_dt)),}
  \DataTypeTok{caption=}\StringTok{"DE Results at FDR = 0.05"}\NormalTok{) }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\NormalTok{kableExtra}\OperatorTok{::}\KeywordTok{kable\_styling}\NormalTok{(}\DataTypeTok{full\_width =}\NormalTok{ F)}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{tab:brcaRna-preproc-lmFit}DE Results at FDR = 0.05}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
  & Down & NotSig & Up\\
\hline
LumAvsOther & 6301 & 4498 & 8607\\
\hline
\end{tabular}
\end{table}
...
\CommentTok{\# log{-}fold{-}change vs ave{-}expr}
\NormalTok{limma}\OperatorTok{::}\KeywordTok{plotMD}\NormalTok{(brcaRna\_geneExpression\_F\_efit,}
 \DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\OperatorTok{{-}}\FloatTok{0.5}\NormalTok{, }\FloatTok{0.5}\NormalTok{),}
 \DataTypeTok{column=}\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{,}
 \DataTypeTok{status=}\NormalTok{brcaRna\_geneExpression\_F\_efit\_dt[,}\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{],}
 \DataTypeTok{hl.pch =} \DecValTok{16}\NormalTok{, }\DataTypeTok{hl.col =} \KeywordTok{c}\NormalTok{(}\StringTok{"lightblue"}\NormalTok{, }\StringTok{"pink"}\NormalTok{), }\DataTypeTok{hl.cex =} \FloatTok{.5}\NormalTok{,}
 \DataTypeTok{bg.pch =} \DecValTok{16}\NormalTok{, }\DataTypeTok{bg.col =} \StringTok{"grey"}\NormalTok{, }\DataTypeTok{bg.cex =} \FloatTok{0.5}\NormalTok{,}
 \DataTypeTok{main =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{,}
 \DataTypeTok{xlab =} \KeywordTok{paste0}\NormalTok{(}
    \StringTok{"Average log{-}expression: IQR="}\NormalTok{,}
    \KeywordTok{paste}\NormalTok{(}\KeywordTok{round}\NormalTok{(}\KeywordTok{quantile}\NormalTok{(brcaRna\_geneExpression\_F\_efit}\OperatorTok{$}\NormalTok{Amean, }\DataTypeTok{prob =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{/}\StringTok{ }\DecValTok{4}\NormalTok{), }\DecValTok{2}\NormalTok{),}
      \DataTypeTok{collapse =} \StringTok{", "}
\NormalTok{    )}
\NormalTok{  ),}
  \DataTypeTok{ylab =} \KeywordTok{paste0}\NormalTok{(}
    \StringTok{"log{-}fold{-}change: IQR="}\NormalTok{,}
    \KeywordTok{paste}\NormalTok{(}\KeywordTok{round}\NormalTok{(}\KeywordTok{quantile}\NormalTok{(brcaRna\_geneExpression\_F\_efit}\OperatorTok{$}\NormalTok{coefficients[, }\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{], }\DataTypeTok{prob =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{/}\StringTok{ }\DecValTok{4}\NormalTok{), }\DecValTok{2}\NormalTok{),}
      \DataTypeTok{collapse =} \StringTok{", "}
\NormalTok{    )}
\NormalTok{  ),}
  \DataTypeTok{legend =}\NormalTok{ F, }\DataTypeTok{cex.lab=}\FloatTok{1.5}
\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{h =} \DecValTok{0}\NormalTok{, }\DataTypeTok{col =} \StringTok{"black"}\NormalTok{)}
\KeywordTok{rug}\NormalTok{(}\KeywordTok{quantile}\NormalTok{(brcaRna\_geneExpression\_F\_efit}\OperatorTok{$}\NormalTok{coefficients[, }\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{], }\DataTypeTok{prob =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{/}\StringTok{ }\DecValTok{4}\NormalTok{),}
  \DataTypeTok{col =} \StringTok{"purple"}\NormalTok{,}
  \DataTypeTok{ticksize =} \FloatTok{.03}\NormalTok{, }\DataTypeTok{side =} \DecValTok{2}\NormalTok{, }\DataTypeTok{lwd =} \DecValTok{2}
\NormalTok{)}
\KeywordTok{rug}\NormalTok{(}\KeywordTok{quantile}\NormalTok{(brcaRna\_geneExpression\_F\_efit}\OperatorTok{$}\NormalTok{Amean, }\DataTypeTok{prob =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{/}\StringTok{ }\DecValTok{4}\NormalTok{),}
  \DataTypeTok{col =} \StringTok{"purple"}\NormalTok{,}
  \DataTypeTok{ticksize =} \FloatTok{.03}\NormalTok{, }\DataTypeTok{side =} \DecValTok{1}\NormalTok{, }\DataTypeTok{lwd =} \DecValTok{2}
\NormalTok{)}
...
\KeywordTok{boxplot}\NormalTok{(}\KeywordTok{split}\NormalTok{(}
\NormalTok{ brcaRna\_geneExpression\_F\_efit}\OperatorTok{$}\NormalTok{coefficients[, }\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{],}
\NormalTok{ brcaRna\_geneExpression\_F\_efit\_dt[,}\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{]),}
 \DataTypeTok{outline=}\NormalTok{F,}
 \DataTypeTok{border=}\KeywordTok{c}\NormalTok{(}\StringTok{"pink"}\NormalTok{, }\StringTok{"grey"}\NormalTok{, }\StringTok{"lightblue"}\NormalTok{), }\DataTypeTok{xaxt=}\StringTok{\textquotesingle{}n\textquotesingle{}}\NormalTok{,}
 \DataTypeTok{ylab=}\StringTok{\textquotesingle{}log{-}fold{-}change\textquotesingle{}}\NormalTok{, }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\OperatorTok{{-}}\NormalTok{.}\DecValTok{4}\NormalTok{, }\FloatTok{.4}\NormalTok{),}
 \DataTypeTok{cex.lab=}\FloatTok{1.5}
...
\begin{figure}
\centering
\includegraphics{Static/figures/brcaRna-preproc-mdPlotEfit-1.pdf}
\caption{\label{fig:brcaRna-preproc-mdPlotEfit}LumA vs Other - Genes Identified at FDR = 0,05}
\end{figure}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#SKIP {-} DONT HAVE ACGT }
\NormalTok{SKIP <{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{() \{}
\CommentTok{\# gc vs identification}
\NormalTok{genes\_ndx <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(}\KeywordTok{rownames}\NormalTok{(brcaRna\_geneExpression\_F\_efit), brcaRna\_genes\_annotF}\OperatorTok{$}\NormalTok{geneSymbol)}
\ControlFlowTok{if}\NormalTok{(}\KeywordTok{sum}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(genes\_ndx))) }\KeywordTok{stop}\NormalTok{(}\StringTok{"brcaRna\_geneExpression\_F\_efit/brcaRna\_genes\_annotF: genes mismatch"}\NormalTok{)}
\NormalTok{GC\_vec <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(brcaRna\_genes\_annotF[genes\_ndx,],(G}\OperatorTok{+}\NormalTok{C)}\OperatorTok{/}\NormalTok{(A}\OperatorTok{+}\NormalTok{C}\OperatorTok{+}\NormalTok{G}\OperatorTok{+}\NormalTok{T))}
...
\NormalTok{brcaRna\_geneExpression\_F\_logFC\_sum <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(}
 \KeywordTok{split}\NormalTok{(}
\NormalTok{ brcaRna\_geneExpression\_F\_efit}\OperatorTok{$}\NormalTok{coefficients[, }\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{],}
\NormalTok{ brcaRna\_geneExpression\_F\_efit\_dt[,}\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{]),}
\NormalTok{ quantile, }\DataTypeTok{prob =}\NormalTok{ (}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{) }\OperatorTok{/}\StringTok{ }\DecValTok{4}\NormalTok{)}

\KeywordTok{colnames}\NormalTok{(brcaRna\_geneExpression\_F\_logFC\_sum) <{-}}\StringTok{ }\KeywordTok{as.character}\NormalTok{(}\KeywordTok{factor}\NormalTok{(}
 \KeywordTok{colnames}\NormalTok{(brcaRna\_geneExpression\_F\_logFC\_sum), }
 \DataTypeTok{levels=}\KeywordTok{c}\NormalTok{(}\StringTok{"{-}1"}\NormalTok{, }\StringTok{"0"}\NormalTok{, }\StringTok{"1"}\NormalTok{),}
 \DataTypeTok{labels=}\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}down\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}notDE\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}up\textquotesingle{}}\NormalTok{)}
\NormalTok{))}


\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(brcaRna\_geneExpression\_F\_logFC\_sum,}
  \DataTypeTok{digits =} \DecValTok{2}\NormalTok{,}
  \DataTypeTok{caption =} \StringTok{"log FC quartiles by gene identification"}\NormalTok{) }\OperatorTok{\%>\%}
\StringTok{  }\NormalTok{kableExtra}\OperatorTok{::}\KeywordTok{kable\_styling}\NormalTok{(}\DataTypeTok{full\_width =}\NormalTok{ F)}
\end{Highlighting}
...
\caption{\label{tab:brcaRna-preproc-quantlogFC}log FC quartiles by gene identification}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
  & down & notDE & up\\
...
\NormalTok{limma}\OperatorTok{::}\KeywordTok{plotMD}\NormalTok{(brcaRna\_geneExpression\_F\_efit,}
 ...
 \DataTypeTok{column=}\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{,}
 \DataTypeTok{status=}\NormalTok{brcaRna\_geneExpression\_F\_tfit\_dt[,}\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{],}
 \DataTypeTok{hl.pch =} \DecValTok{16}\NormalTok{, }\DataTypeTok{hl.col =} \KeywordTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"red"}\NormalTok{), }\DataTypeTok{hl.cex =} \FloatTok{.7}\NormalTok{,}
 \DataTypeTok{bg.pch =} \DecValTok{16}\NormalTok{, }\DataTypeTok{bg.col =} \StringTok{"grey"}\NormalTok{, }\DataTypeTok{bg.cex =} \FloatTok{0.5}\NormalTok{,}
 \DataTypeTok{main =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{,}
 \DataTypeTok{xlab =} \KeywordTok{paste0}\NormalTok{(}
...
\begin{figure}
\centering
\includegraphics{Static/figures/brcaRna-preproc-mdPlotTfit-1.pdf}
\caption{\label{fig:brcaRna-preproc-mdPlotTfit}LumA vs Other - Identified Genes at FDR = 0,05 and logFC \textgreater{} 10\%}
\end{figure}

\hypertarget{breast-rnaseq-snr-regime}{%
\section{Signal-to-noise ratio regime}\label{breast-rnaseq-snr-regime}}
...
\NormalTok{Effect <{-}}\StringTok{ }\KeywordTok{abs}\NormalTok{(brcaRna\_geneExpression\_F\_efit}\OperatorTok{$}\NormalTok{coefficients[,}\StringTok{\textquotesingle{}LumAvsOther\textquotesingle{}}\NormalTok{])}
\NormalTok{Noise <{-}}\StringTok{ }\NormalTok{brcaRna\_geneExpression\_F\_efit}\OperatorTok{$}\NormalTok{sigma}
\NormalTok{SNR <{-}}\StringTok{ }\NormalTok{Effect}\OperatorTok{/}\NormalTok{Noise}
...
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{brcaRna\_train\_sampID\_vec <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(brcaRna\_sampDesc,}
\NormalTok{brcaRna\_sampDesc}\OperatorTok{$}\NormalTok{sampID[caret}\OperatorTok{::}\KeywordTok{createDataPartition}\NormalTok{(}\DataTypeTok{y=}\NormalTok{group, }\DataTypeTok{p=}\NormalTok{trainP, }\DataTypeTok{list=}\NormalTok{F)]}
\NormalTok{)}

\NormalTok{brcaRna\_test\_sampID\_vec <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(brcaRna\_sampDesc,}
\KeywordTok{setdiff}\NormalTok{(sampID, brcaRna\_train\_sampID\_vec)}
\NormalTok{)}

\NormalTok{brcaRna\_train\_group\_vec <{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(brcaRna\_sampDesc[brcaRna\_train\_sampID\_vec, }\StringTok{\textquotesingle{}group\textquotesingle{}}\NormalTok{],}
\DataTypeTok{levels=}\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}Other\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{))}
\KeywordTok{names}\NormalTok{(brcaRna\_train\_group\_vec) <{-}}\StringTok{ }\NormalTok{brcaRna\_sampDesc[brcaRna\_train\_sampID\_vec, }\StringTok{\textquotesingle{}sampID\textquotesingle{}}\NormalTok{]}

\NormalTok{brcaRna\_test\_group\_vec <{-}}\StringTok{ }\KeywordTok{factor}\NormalTok{(brcaRna\_sampDesc[brcaRna\_test\_sampID\_vec, }\StringTok{\textquotesingle{}group\textquotesingle{}}\NormalTok{],}
\DataTypeTok{levels=}\KeywordTok{c}\NormalTok{(}\StringTok{\textquotesingle{}Other\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{))}
\KeywordTok{names}\NormalTok{(brcaRna\_test\_group\_vec) <{-}}\StringTok{ }\NormalTok{brcaRna\_sampDesc[brcaRna\_test\_sampID\_vec, }\StringTok{\textquotesingle{}sampID\textquotesingle{}}\NormalTok{]}

\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{table}\NormalTok{(brcaRna\_train\_group\_vec),}
  \DataTypeTok{caption=}\StringTok{"Train set"}\NormalTok{) }\OperatorTok{\%>\%}
\StringTok{   }\NormalTok{kableExtra}\OperatorTok{::}\KeywordTok{kable\_styling}\NormalTok{(}\DataTypeTok{full\_width =}\NormalTok{ F)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,cv\_fit}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{ train\_oofPred\_1se\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
  \KeywordTok{logistic\_f}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_1se]) }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}\_Other\textquotesingle{}}\NormalTok{)}
\NormalTok{ train\_oofPred\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(train\_oofPred\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_train\_group\_vec)}

\NormalTok{ ndx\_min <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{lambda.min,cv\_fit}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{ train\_oofPred\_min\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
  \KeywordTok{logistic\_f}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_min]) }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}\_Other\textquotesingle{}}\NormalTok{)}
\NormalTok{ train\_oofPred\_min\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(train\_oofPred\_min\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_train\_group\_vec)}
...
\NormalTok{  cv\_fit, }
  ...
  \DataTypeTok{type=}\StringTok{"class"}
\NormalTok{ )}
\NormalTok{ test\_pred\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(test\_pred\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_test\_group\_vec)}
...
\NormalTok{  cv\_fit, }
  ...
  \DataTypeTok{type=}\StringTok{"class"}
\NormalTok{ )}
\NormalTok{ test\_pred\_min\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(test\_pred\_min\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_test\_group\_vec)}
...
\NormalTok{ lasso\_errors\_mtx <{-}}\StringTok{ }\KeywordTok{plot\_cv\_f}\NormalTok{(brcaRna\_cv\_lasso, }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{5}\NormalTok{))}
 \KeywordTok{title}\NormalTok{(}\StringTok{\textquotesingle{}lasso\textquotesingle{}}\NormalTok{)}

\NormalTok{ rifge\_errors\_mtx <{-}}\StringTok{ }\KeywordTok{plot\_cv\_f}\NormalTok{(brcaRna\_cv\_ridge, }\DataTypeTok{Nzero=}\NormalTok{F, }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{5}\NormalTok{))}
 \KeywordTok{title}\NormalTok{(}\StringTok{\textquotesingle{}ridge\textquotesingle{}}\NormalTok{)}

\NormalTok{ enet\_errors\_mtx <{-}}\StringTok{  }\KeywordTok{plot\_cv\_f}\NormalTok{(brcaRna\_cv\_enet, }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{5}\NormalTok{))}
 \KeywordTok{title}\NormalTok{(}\StringTok{\textquotesingle{}enet\textquotesingle{}}\NormalTok{)}

 \KeywordTok{mtext}\NormalTok{(}\DataTypeTok{side=}\DecValTok{1}\NormalTok{, }\DataTypeTok{outer=}\NormalTok{T, }\DataTypeTok{cex=}\FloatTok{1.25}\NormalTok{, }\StringTok{\textquotesingle{}log(Lambda)\textquotesingle{}}\NormalTok{)}
 \KeywordTok{mtext}\NormalTok{(}\DataTypeTok{side=}\DecValTok{2}\NormalTok{, }\DataTypeTok{outer=}\NormalTok{T, }\DataTypeTok{cex=}\FloatTok{1.25}\NormalTok{, brcaRna\_cv\_lasso}\OperatorTok{$}\NormalTok{name)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\includegraphics{Static/figures/brcaRna-glmnetFit-lookFits-1.pdf}
\caption{\label{fig:brcaRna-glmnetFit-lookFits}compare fits}
\end{figure}
...
\CommentTok{\#\#\# CLEAR CACHE}
\CommentTok{\# only report  1se}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se, brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{ndx\_min <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda.min, brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda)}
...
\CommentTok{\# Get relaxed lasso (gamma=0) oof error}
\NormalTok{train\_oofPred\_relaxed\_1se\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
  \KeywordTok{logistic\_f}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{"g:0"}\NormalTok{]][, ndx\_1se]) }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{"LumA"}\NormalTok{, }\StringTok{"Other"}
\NormalTok{)}
\NormalTok{train\_oofPred\_relaxed\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(train\_oofPred\_relaxed\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_train\_group\_vec)}

\CommentTok{\# blended mix (gamma=0.5)}
\NormalTok{train\_oofPred\_blended\_1se\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
  \KeywordTok{logistic\_f}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{"g:0.5"}\NormalTok{]][, ndx\_1se]) }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{"LumA"}\NormalTok{, }\StringTok{"Other"}
\NormalTok{)}
\NormalTok{train\_oofPred\_blended\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(train\_oofPred\_blended\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_train\_group\_vec)}
...
\NormalTok{  brcaRna\_cv\_lassoR,}
  ...
  \DataTypeTok{gamma =} \DecValTok{0}
\NormalTok{)}
\NormalTok{test\_pred\_relaxed\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(test\_pred\_relaxed\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_test\_group\_vec)}
...
\NormalTok{  brcaRna\_cv\_lassoR,}
  ...
  \DataTypeTok{gamma =} \FloatTok{0.5}
\NormalTok{)}
\NormalTok{test\_pred\_blended\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(test\_pred\_blended\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_test\_group\_vec)}


\NormalTok{brcaRna\_cv\_lassoR\_1se\_error <{-}}\StringTok{ }\NormalTok{brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{cvm[brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda}\OperatorTok{==}\NormalTok{brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda.min]}

\NormalTok{cv\_blended\_statlist <{-}}\StringTok{ }\NormalTok{brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{relaxed}\OperatorTok{$}\NormalTok{statlist[[}\StringTok{\textquotesingle{}g:0.5\textquotesingle{}}\NormalTok{]]}
\NormalTok{cv\_blended\_1se\_error <{-}}\StringTok{ }\NormalTok{cv\_blended\_statlist}\OperatorTok{$}\NormalTok{cvm[cv\_blended\_statlist}\OperatorTok{$}\NormalTok{lambda}\OperatorTok{==}
\StringTok{   }\NormalTok{brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{relaxed}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se]}
 


\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{t}\NormalTok{(}\KeywordTok{data.frame}\NormalTok{(}
  \DataTypeTok{train\_relaxed  =}\NormalTok{ brcaRna\_cv\_lassoR\_1se\_error,}
  \DataTypeTok{train\_blended  =}\NormalTok{ cv\_blended\_1se\_error,}
  \CommentTok{\#train\_relaxed\_oof = train\_oofPred\_relaxed\_1se\_error,}
  \CommentTok{\#train\_blended\_oof = train\_oofPred\_blended\_1se\_error,}
  \DataTypeTok{test\_relaxed  =}\NormalTok{ test\_pred\_relaxed\_1se\_error,}
...
\CommentTok{\# train}
\CommentTok{\# lasso}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(brcaRna\_cv\_lasso}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,brcaRna\_cv\_lasso}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_lasso\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(brcaRna\_cv\_lasso}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_1se])}
\NormalTok{train\_lasso\_roc <{-}}\StringTok{ }\NormalTok{pROC}\OperatorTok{::}\KeywordTok{roc}\NormalTok{(}
 \DataTypeTok{response =} \KeywordTok{as.numeric}\NormalTok{(brcaRna\_train\_group\_vec}\OperatorTok{==}\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{),}
 \DataTypeTok{predictor =}\NormalTok{ train\_lasso\_oofProb\_vec)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\# enet}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(brcaRna\_cv\_enet}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,brcaRna\_cv\_enet}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_enet\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(brcaRna\_cv\_enet}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_1se])}
\NormalTok{train\_enet\_roc <{-}}\StringTok{ }\NormalTok{pROC}\OperatorTok{::}\KeywordTok{roc}\NormalTok{(}
 \DataTypeTok{response =} \KeywordTok{as.numeric}\NormalTok{(brcaRna\_train\_group\_vec}\OperatorTok{==}\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{),}
 \DataTypeTok{predictor =}\NormalTok{ train\_enet\_oofProb\_vec)}
\end{Highlighting}
...
\CommentTok{\# lasso {-} relaxed}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_relaxed\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{\textquotesingle{}g:0\textquotesingle{}}\NormalTok{]][,ndx\_1se])}
\NormalTok{train\_relaxed\_roc <{-}}\StringTok{ }\NormalTok{pROC}\OperatorTok{::}\KeywordTok{roc}\NormalTok{(}
 \DataTypeTok{response =} \KeywordTok{as.numeric}\NormalTok{(brcaRna\_train\_group\_vec}\OperatorTok{==}\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{),}
 \DataTypeTok{predictor =}\NormalTok{ train\_relaxed\_oofProb\_vec)}
\end{Highlighting}
...
\CommentTok{\# blended mix (gamma=0.5)}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_blended\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{\textquotesingle{}g:0.5\textquotesingle{}}\NormalTok{]][,ndx\_1se])}
\NormalTok{train\_blended\_roc <{-}}\StringTok{ }\NormalTok{pROC}\OperatorTok{::}\KeywordTok{roc}\NormalTok{(}
 \DataTypeTok{response =} \KeywordTok{as.numeric}\NormalTok{(brcaRna\_train\_group\_vec}\OperatorTok{==}\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{),}
 \DataTypeTok{predictor =}\NormalTok{ train\_blended\_oofProb\_vec)}
\end{Highlighting}
...
\NormalTok{  tmp <{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}
    \DataTypeTok{train =} \KeywordTok{split}\NormalTok{(train\_1se\_predProb\_vec, brcaRna\_train\_group\_vec),}
    \DataTypeTok{test =} \KeywordTok{split}\NormalTok{(test\_1se\_predProb\_vec, brcaRna\_test\_group\_vec)}
\NormalTok{  )}
  \KeywordTok{names}\NormalTok{(tmp) <{-}}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, }\KeywordTok{sub}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{."}\NormalTok{, }\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, }\KeywordTok{names}\NormalTok{(tmp)))}
...
\hypertarget{compare-predictions-at-misclassified-samples-1}{%
\section{Compare predictions at misclassified samples}\label{compare-predictions-at-misclassified-samples-1}}
...
\NormalTok{train\_lasso\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(brcaRna\_cv\_lasso}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_1se])}
\NormalTok{train\_lasso\_oofClass\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
\NormalTok{   train\_lasso\_oofProb\_vec }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}\_Other\textquotesingle{}}\NormalTok{)}

\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(brcaRna\_cv\_enet}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,brcaRna\_cv\_enet}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_enet\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(brcaRna\_cv\_enet}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_1se])}
\NormalTok{train\_enet\_oofClass\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
\NormalTok{   train\_enet\_oofProb\_vec }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}\_Other\textquotesingle{}}\NormalTok{)}

\CommentTok{\# RECALL: brcaRna\_cv\_lassoR$nzero[brcaRna\_cv\_lassoR$lambda==brcaRna\_cv\_lassoR$lambda.1se]}
\CommentTok{\# train {-} oof}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_relaxed\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{\textquotesingle{}g:0\textquotesingle{}}\NormalTok{]][,ndx\_1se])}
\NormalTok{train\_relaxed\_oofClass\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
\NormalTok{   train\_relaxed\_oofProb\_vec }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}\_Other\textquotesingle{}}\NormalTok{)}

\CommentTok{\# RECALL $\textasciigrave{}r brcaRna\_cv\_lassoR$relaxed$nzero.1se\textasciigrave{}$ features (vertical}
\CommentTok{\#  cv\_blended\_statlist <{-} brcaRna\_cv\_lassoR$relaxed$statlist[[\textquotesingle{}g:0.5\textquotesingle{}]]}
\CommentTok{\#  cv\_blended\_1se\_error <{-} cv\_blended\_statlist$cvm[cv\_blended\_statlist$lambda==}
      \CommentTok{\#brcaRna\_cv\_lassoR$relaxed$lambda.1se]}

\CommentTok{\# train {-} oof}
\NormalTok{cv\_blended\_statlist <{-}}\StringTok{ }\NormalTok{brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{relaxed}\OperatorTok{$}\NormalTok{statlist[[}\StringTok{\textquotesingle{}g:0.5\textquotesingle{}}\NormalTok{]]}
\NormalTok{ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{relaxed}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se, cv\_blended\_statlist}\OperatorTok{$}\NormalTok{lambda)}
\NormalTok{train\_blended\_oofProb\_vec <{-}}\StringTok{ }\KeywordTok{logistic\_f}\NormalTok{(brcaRna\_cv\_lassoR}\OperatorTok{$}\NormalTok{fit.preval[[}\StringTok{\textquotesingle{}g:0.5\textquotesingle{}}\NormalTok{]][,ndx\_1se])}
\NormalTok{train\_blended\_oofClass\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
\NormalTok{   train\_blended\_oofProb\_vec }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{\textquotesingle{}LumA\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}\_Other\textquotesingle{}}\NormalTok{)}


\NormalTok{misclass\_id\_vec <{-}}\StringTok{ }\KeywordTok{unique}\NormalTok{(}\KeywordTok{c}\NormalTok{(}
 \KeywordTok{names}\NormalTok{(train\_lasso\_oofClass\_vec)[train\_lasso\_oofClass\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_train\_group\_vec],}
 \KeywordTok{names}\NormalTok{(train\_enet\_oofClass\_vec)[train\_enet\_oofClass\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_train\_group\_vec],}
 \KeywordTok{names}\NormalTok{(train\_relaxed\_oofClass\_vec)[train\_relaxed\_oofClass\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_train\_group\_vec],}
 \KeywordTok{names}\NormalTok{(train\_blended\_oofClass\_vec)[train\_blended\_oofClass\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{brcaRna\_train\_group\_vec]}
\NormalTok{ )}
\NormalTok{)}
...
\NormalTok{  Mycol <{-}}\StringTok{ }\KeywordTok{colorpanel}\NormalTok{(}\DecValTok{1000}\NormalTok{, }\StringTok{"blue"}\NormalTok{, }\StringTok{"red"}\NormalTok{)}
  \KeywordTok{heatmap.2}\NormalTok{(}
    \DataTypeTok{x=}\KeywordTok{t}\NormalTok{(brcaRna\_train\_geneExpr\_mtx[,lasso\_coef\_frm}\OperatorTok{$}\NormalTok{gene[}\OperatorTok{{-}}\DecValTok{1}\NormalTok{]]),}
    \DataTypeTok{scale=}\StringTok{"row"}\NormalTok{,}
    \DataTypeTok{labRow=}\NormalTok{lasso\_coef\_frm}\OperatorTok{$}\NormalTok{gene,}
    \DataTypeTok{labCol=}\NormalTok{brcaRna\_train\_group\_vec,}
    \DataTypeTok{col=}\NormalTok{Mycol, }
    \DataTypeTok{trace=}\StringTok{"none"}\NormalTok{, }\DataTypeTok{density.info=}\StringTok{"none"}\NormalTok{, }
    \CommentTok{\#margin=c(8,6), lhei=c(2,10), }
    \CommentTok{\#lwid=c(0.1,4), \#lhei=c(0.1,4)}
    \DataTypeTok{key=}\NormalTok{F,}
    \DataTypeTok{ColSideColors=}\KeywordTok{ifelse}\NormalTok{(brcaRna\_train\_group\_vec}\OperatorTok{==}\StringTok{\textquotesingle{}\_Other\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}green\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}red\textquotesingle{}}\NormalTok{),}
    \DataTypeTok{dendrogram=}\StringTok{"both"}\NormalTok{,}
    \DataTypeTok{main=}\KeywordTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}lasso genes {-} N =\textquotesingle{}}\NormalTok{, }\KeywordTok{nrow}\NormalTok{(lasso\_coef\_frm)}\OperatorTok{{-}}\DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  Mycol <{-}}\StringTok{ }\KeywordTok{colorpanel}\NormalTok{(}\DecValTok{1000}\NormalTok{, }\StringTok{"blue"}\NormalTok{, }\StringTok{"red"}\NormalTok{)}
  \KeywordTok{heatmap.2}\NormalTok{(}
    \DataTypeTok{x=}\KeywordTok{t}\NormalTok{(brcaRna\_train\_geneExpr\_mtx[,enet\_coef\_frm}\OperatorTok{$}\NormalTok{gene[}\OperatorTok{{-}}\DecValTok{1}\NormalTok{]]),}
    \DataTypeTok{scale=}\StringTok{"row"}\NormalTok{,}
    \DataTypeTok{labRow=}\NormalTok{enet\_coef\_frm}\OperatorTok{$}\NormalTok{gene,}
    \DataTypeTok{labCol=}\NormalTok{brcaRna\_train\_group\_vec,}
    \DataTypeTok{col=}\NormalTok{Mycol, }
...
\CommentTok{\#\#\# CLEAR CACHE}
\KeywordTok{plot}\NormalTok{(}
 \KeywordTok{log}\NormalTok{(brcaRna\_cv\_lassoAll\_lst[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{lambda),}
\NormalTok{ brcaRna\_cv\_lassoAll\_lst[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{cvm,}
 \DataTypeTok{lwd=}\DecValTok{2}\NormalTok{,}
 \DataTypeTok{xlab=}\StringTok{\textquotesingle{}log(Lambda)\textquotesingle{}}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{\textquotesingle{}CV Misclassification Error\textquotesingle{}}\NormalTok{, }\DataTypeTok{type=}\StringTok{\textquotesingle{}l\textquotesingle{}}\NormalTok{, }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{.5}\NormalTok{)}
\NormalTok{)}

\ControlFlowTok{for}\NormalTok{(JJ }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\KeywordTok{length}\NormalTok{(brcaRna\_cv\_lassoAll\_lst))}
 \KeywordTok{lines}\NormalTok{(}
  \KeywordTok{log}\NormalTok{(brcaRna\_cv\_lassoAll\_lst[[JJ]]}\OperatorTok{$}\NormalTok{lambda),}
\NormalTok{  brcaRna\_cv\_lassoAll\_lst[[JJ]]}\OperatorTok{$}\NormalTok{cvm,}
  \DataTypeTok{lwd=}\DecValTok{2}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{Static/figures/brca-rnaseq-plot-lassoAll-1.pdf}
\caption{\label{fig:brca-rnaseq-plot-lassoAll}Repeated cv lasso models fitted to all samples}
\end{figure}
...
\CommentTok{\# nzero}
\NormalTok{nzero\_1se\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(brcaRna\_cv\_lassoAll\_lst,}
 \ControlFlowTok{function}\NormalTok{(cv\_fit) cv\_fit}\OperatorTok{$}\NormalTok{nzero[cv\_fit}\OperatorTok{$}\NormalTok{lambda }\OperatorTok{==}\StringTok{ }\NormalTok{cv\_fit}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se])}

\NormalTok{nzero\_min\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(brcaRna\_cv\_lassoAll\_lst,}
 \ControlFlowTok{function}\NormalTok{(cv\_fit) cv\_fit}\OperatorTok{$}\NormalTok{nzero[cv\_fit}\OperatorTok{$}\NormalTok{lambda }\OperatorTok{==}\StringTok{ }\NormalTok{cv\_fit}\OperatorTok{$}\NormalTok{lambda.min])}

\KeywordTok{boxplot}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\StringTok{\textasciigrave{}}\DataTypeTok{1se}\StringTok{\textasciigrave{}}\NormalTok{=nzero\_1se\_vec, }\DataTypeTok{min =}\NormalTok{ nzero\_min\_vec), }\DataTypeTok{ylab=}\StringTok{"Selected Features"}\NormalTok{)}

\CommentTok{\# error}
\NormalTok{error\_1se\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(brcaRna\_cv\_lassoAll\_lst,}
 \ControlFlowTok{function}\NormalTok{(cv\_fit) cv\_fit}\OperatorTok{$}\NormalTok{cvm[cv\_fit}\OperatorTok{$}\NormalTok{lambda }\OperatorTok{==}\StringTok{ }\NormalTok{cv\_fit}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se])}

\NormalTok{error\_min\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(brcaRna\_cv\_lassoAll\_lst,}
 \ControlFlowTok{function}\NormalTok{(cv\_fit) cv\_fit}\OperatorTok{$}\NormalTok{cvm[cv\_fit}\OperatorTok{$}\NormalTok{lambda }\OperatorTok{==}\StringTok{ }\NormalTok{cv\_fit}\OperatorTok{$}\NormalTok{lambda.min])}

\KeywordTok{boxplot}\NormalTok{(}
 \KeywordTok{list}\NormalTok{(}\StringTok{\textasciigrave{}}\DataTypeTok{1se}\StringTok{\textasciigrave{}}\NormalTok{=error\_1se\_vec, }\DataTypeTok{min =}\NormalTok{ error\_min\_vec), }
 \DataTypeTok{ylab=}\NormalTok{brcaRna\_cv\_lassoAll\_lst[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{name,}
 \DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\FloatTok{0.10}\NormalTok{, }\FloatTok{.13}\NormalTok{)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\# predicted probs {-} 1se}
\NormalTok{lassoAll\_predResp\_1se\_mtx <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(brcaRna\_cv\_lassoAll\_lst, }\ControlFlowTok{function}\NormalTok{(cv\_fit) \{ }
\NormalTok{  ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,cv\_fit}\OperatorTok{$}\NormalTok{lambda)}
  \KeywordTok{logistic\_f}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_1se])}
\NormalTok{ \})}
\NormalTok{lassoAll\_predResp\_1se\_vec <{-}}\StringTok{ }\KeywordTok{rowMeans}\NormalTok{(lassoAll\_predResp\_1se\_mtx)}
...
\CommentTok{\# predicted probs {-} min}
\NormalTok{lassoAll\_predResp\_min\_mtx <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(brcaRna\_cv\_lassoAll\_lst, }\ControlFlowTok{function}\NormalTok{(cv\_fit) \{ }
\NormalTok{  ndx\_min <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{lambda.min,cv\_fit}\OperatorTok{$}\NormalTok{lambda)}
  \KeywordTok{logistic\_f}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_min])}
\NormalTok{ \})}
\NormalTok{lassoAll\_predResp\_min\_vec <{-}}\StringTok{ }\KeywordTok{rowMeans}\NormalTok{(lassoAll\_predResp\_min\_mtx)}
...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{), }\DataTypeTok{mar=}\KeywordTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\NormalTok{tmp <{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}
 \StringTok{\textasciigrave{}}\DataTypeTok{1se}\StringTok{\textasciigrave{}}\NormalTok{ =}\StringTok{ }\KeywordTok{split}\NormalTok{(lassoAll\_predResp\_1se\_vec, brcaRna\_all\_group\_vec),}
 \DataTypeTok{min =} \KeywordTok{split}\NormalTok{(lassoAll\_predResp\_min\_vec, brcaRna\_all\_group\_vec)}
\NormalTok{)}
\KeywordTok{names}\NormalTok{(tmp) <{-}}\StringTok{ }\KeywordTok{sub}\NormalTok{(}\StringTok{\textquotesingle{}}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{.\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}}\CharTok{\textbackslash{}n}\StringTok{\textquotesingle{}}\NormalTok{, }\KeywordTok{names}\NormalTok{(tmp))}
...
\NormalTok{       cv\_fit,}
       ...
       \DataTypeTok{type=}\StringTok{"class"}
\NormalTok{      )}
\NormalTok{      test\_1se\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(test\_pred\_1se\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{sim\_stage\_brcaRna\_test\_group\_vec)}
...
\ControlFlowTok{for}\NormalTok{(SIM }\ControlFlowTok{in} \KeywordTok{unique}\NormalTok{(brcaRna\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{SimNo)[}\DecValTok{1}\NormalTok{])\{}

\NormalTok{SimNum <{-}}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{sub}\NormalTok{(}\StringTok{\textquotesingle{}Sim\_\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{,SIM))}

\NormalTok{simNo\_results\_frm <{-}}\StringTok{ }\NormalTok{brcaRna\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(SimNo}\OperatorTok{==}\NormalTok{SIM)}
...
\CommentTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
\CommentTok{\#\# cv}
\NormalTok{cv\_1se\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(brcaRna\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{brcaRna\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
\NormalTok{ sizeVal\_cv\_1se\_lst <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(sizeVal\_results\_frm, }\KeywordTok{split}\NormalTok{(cv\_1se, SimNo))}
 \KeywordTok{sapply}\NormalTok{(sizeVal\_cv\_1se\_lst, median)}
\NormalTok{\})}
\KeywordTok{names}\NormalTok{(cv\_1se\_Bysize\_lst) <{-}}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}
\NormalTok{ stringr}\OperatorTok{::}\KeywordTok{str\_pad}\NormalTok{(}\KeywordTok{unique}\NormalTok{(brcaRna\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size), }\DataTypeTok{width=}\DecValTok{3}\NormalTok{, }\DataTypeTok{pad=}\StringTok{\textquotesingle{}0\textquotesingle{}}\NormalTok{), }\StringTok{\textquotesingle{}\_cv\textquotesingle{}}\NormalTok{)}

\CommentTok{\#\# test}
\NormalTok{test\_1se\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(brcaRna\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{brcaRna\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
\NormalTok{ sizeVal\_test\_1se\_lst <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(sizeVal\_results\_frm, }\KeywordTok{split}\NormalTok{(test\_1se, SimNo))}
 \KeywordTok{sapply}\NormalTok{(sizeVal\_test\_1se\_lst, median)}
...
\CommentTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
\CommentTok{\#\# cv}
\NormalTok{cv\_min\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(brcaRna\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{brcaRna\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
\NormalTok{ sizeVal\_cv\_min\_lst <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(sizeVal\_results\_frm, }\KeywordTok{split}\NormalTok{(cv\_min, SimNo))}
 \KeywordTok{sapply}\NormalTok{(sizeVal\_cv\_min\_lst, median)}
...
\CommentTok{\#\# test}
\NormalTok{test\_min\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(brcaRna\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{brcaRna\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
\NormalTok{ sizeVal\_test\_min\_lst <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(sizeVal\_results\_frm, }\KeywordTok{split}\NormalTok{(test\_min, SimNo))}
 \KeywordTok{sapply}\NormalTok{(sizeVal\_test\_min\_lst, median)}
...
\CommentTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
\CommentTok{\# selected features}
\NormalTok{p\_1se\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(brcaRna\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{brcaRna\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
\NormalTok{ sizeVal\_p\_1se\_lst <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(sizeVal\_results\_frm, }\KeywordTok{split}\NormalTok{(p\_1se, SimNo))}
 \KeywordTok{sapply}\NormalTok{(sizeVal\_p\_1se\_lst, median)}
...
\CommentTok{\# selected signatue features}
\NormalTok{sign\_p\_1se\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(brcaRna\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{brcaRna\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
...
\CommentTok{\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#}
\CommentTok{\# selected features}
\NormalTok{p\_min\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(brcaRna\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{brcaRna\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
\NormalTok{ sizeVal\_p\_min\_lst <{-}}\StringTok{ }\KeywordTok{with}\NormalTok{(sizeVal\_results\_frm, }\KeywordTok{split}\NormalTok{(p\_min, SimNo))}
 \KeywordTok{sapply}\NormalTok{(sizeVal\_p\_min\_lst, median)}
...
\CommentTok{\# selected signatue features}
\NormalTok{sign\_p\_min\_Bysize\_lst <{-}}\StringTok{ }\KeywordTok{lapply}\NormalTok{(}\KeywordTok{unique}\NormalTok{(brcaRna\_lasso\_sim\_results\_frm}\OperatorTok{$}\NormalTok{Size),}
\ControlFlowTok{function}\NormalTok{(SizeVal) \{}
\NormalTok{ sizeVal\_results\_frm <{-}}\StringTok{ }\NormalTok{brcaRna\_lasso\_sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Size}\OperatorTok{==}\NormalTok{SizeVal)}
...
\addcontentsline{toc}{chapter}{Appendix 1 - Sample size in elastic net fits to HCC 5hmC-Seq Data}
...
\CommentTok{\#\#\# CLEAR CACHE}
\KeywordTok{plot}\NormalTok{(}
 \KeywordTok{log}\NormalTok{(hcc5hmC\_cv\_enetAll\_lst[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{lambda),}
\NormalTok{ hcc5hmC\_cv\_enetAll\_lst[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{cvm,}
 \DataTypeTok{lwd=}\DecValTok{2}\NormalTok{,}
 \DataTypeTok{xlab=}\StringTok{\textquotesingle{}log(Lambda)\textquotesingle{}}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{\textquotesingle{}CV Misclassification Error\textquotesingle{}}\NormalTok{, }\DataTypeTok{type=}\StringTok{\textquotesingle{}l\textquotesingle{}}\NormalTok{, }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{.5}\NormalTok{)}
\NormalTok{)}

\ControlFlowTok{for}\NormalTok{(JJ }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\KeywordTok{length}\NormalTok{(hcc5hmC\_cv\_enetAll\_lst))}
 \KeywordTok{lines}\NormalTok{(}
  \KeywordTok{log}\NormalTok{(hcc5hmC\_cv\_enetAll\_lst[[JJ]]}\OperatorTok{$}\NormalTok{lambda),}
\NormalTok{  hcc5hmC\_cv\_enetAll\_lst[[JJ]]}\OperatorTok{$}\NormalTok{cvm,}
  \DataTypeTok{lwd=}\DecValTok{2}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{Static/figures/hcc5hmC-glmnetSuiteB-enet-plot-enetAll-1.pdf}
\caption{\label{fig:hcc5hmC-glmnetSuiteB-enet-plot-enetAll}Repeated cv enet models fitted to all samples}
\end{figure}
...
\CommentTok{\# nzero}
\NormalTok{nzero\_1se\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_enetAll\_lst,}
 \ControlFlowTok{function}\NormalTok{(cv\_fit) cv\_fit}\OperatorTok{$}\NormalTok{nzero[cv\_fit}\OperatorTok{$}\NormalTok{lambda }\OperatorTok{==}\StringTok{ }\NormalTok{cv\_fit}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se])}

\NormalTok{nzero\_min\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_enetAll\_lst,}
 \ControlFlowTok{function}\NormalTok{(cv\_fit) cv\_fit}\OperatorTok{$}\NormalTok{nzero[cv\_fit}\OperatorTok{$}\NormalTok{lambda }\OperatorTok{==}\StringTok{ }\NormalTok{cv\_fit}\OperatorTok{$}\NormalTok{lambda.min])}
...
\CommentTok{\# error}
\NormalTok{error\_1se\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_enetAll\_lst,}
 \ControlFlowTok{function}\NormalTok{(cv\_fit) cv\_fit}\OperatorTok{$}\NormalTok{cvm[cv\_fit}\OperatorTok{$}\NormalTok{lambda }\OperatorTok{==}\StringTok{ }\NormalTok{cv\_fit}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se])}

\NormalTok{error\_min\_vec <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_enetAll\_lst,}
 \ControlFlowTok{function}\NormalTok{(cv\_fit) cv\_fit}\OperatorTok{$}\NormalTok{cvm[cv\_fit}\OperatorTok{$}\NormalTok{lambda }\OperatorTok{==}\StringTok{ }\NormalTok{cv\_fit}\OperatorTok{$}\NormalTok{lambda.min])}

\KeywordTok{boxplot}\NormalTok{(}
 \KeywordTok{list}\NormalTok{(}\StringTok{\textasciigrave{}}\DataTypeTok{1se}\StringTok{\textasciigrave{}}\NormalTok{=error\_1se\_vec, }\DataTypeTok{min =}\NormalTok{ error\_min\_vec), }
 \DataTypeTok{ylab=}\NormalTok{hcc5hmC\_cv\_enetAll\_lst[[}\DecValTok{1}\NormalTok{]]}\OperatorTok{$}\NormalTok{name,}
 \DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\FloatTok{0.06}\NormalTok{, }\FloatTok{.10}\NormalTok{)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\# predicted probs {-} 1se}
\NormalTok{enetAll\_predResp\_1se\_mtx <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_enetAll\_lst, }\ControlFlowTok{function}\NormalTok{(cv\_fit) \{ }
\NormalTok{  ndx\_1se <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se,cv\_fit}\OperatorTok{$}\NormalTok{lambda)}
  \KeywordTok{logistic\_f}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_1se])}
\NormalTok{ \})}
...
\CommentTok{\# predicted probs {-} min}
\NormalTok{enetAll\_predResp\_min\_mtx <{-}}\StringTok{ }\KeywordTok{sapply}\NormalTok{(hcc5hmC\_cv\_enetAll\_lst, }\ControlFlowTok{function}\NormalTok{(cv\_fit) \{ }
\NormalTok{  ndx\_min <{-}}\StringTok{ }\KeywordTok{match}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{lambda.min,cv\_fit}\OperatorTok{$}\NormalTok{lambda)}
  \KeywordTok{logistic\_f}\NormalTok{(cv\_fit}\OperatorTok{$}\NormalTok{fit.preval[,ndx\_min])}
\NormalTok{ \})}
...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{), }\DataTypeTok{mar=}\KeywordTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\NormalTok{tmp <{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}
 \StringTok{\textasciigrave{}}\DataTypeTok{1se}\StringTok{\textasciigrave{}}\NormalTok{ =}\StringTok{ }\KeywordTok{split}\NormalTok{(enetAll\_predResp\_1se\_vec, hcc5hmC\_all\_group\_vec),}
 \DataTypeTok{min =} \KeywordTok{split}\NormalTok{(enetAll\_predResp\_min\_vec, hcc5hmC\_all\_group\_vec)}
\NormalTok{)}
\KeywordTok{names}\NormalTok{(tmp) <{-}}\StringTok{ }\KeywordTok{sub}\NormalTok{(}\StringTok{\textquotesingle{}}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{.\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}}\CharTok{\textbackslash{}n}\StringTok{\textquotesingle{}}\NormalTok{, }\KeywordTok{names}\NormalTok{(tmp))}
