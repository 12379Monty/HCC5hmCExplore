...
\KeywordTok{boxplot}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\StringTok{\textasciigrave{}}\DataTypeTok{1se}\StringTok{\textasciigrave{}}\NormalTok{=nzero\_1se\_vec, }\DataTypeTok{min =}\NormalTok{ nzero\_min\_vec), }\DataTypeTok{ylab=}\StringTok{"Number of selected features"}\NormalTok{)}
...
\addcontentsline{toc}{subsection}{Get quality scores}
...
\addcontentsline{toc}{subsection}{Selected feature list stability}
...
\NormalTok{      cvm\_min <{-}}\StringTok{ }\NormalTok{cv\_fit}\OperatorTok{$}\NormalTok{cvm[ndx\_min]}
      ...
      \CommentTok{\# oof error}
\NormalTok{      oofPred\_min\_vec <{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}
\NormalTok{        cv\_fit}\OperatorTok{$}\NormalTok{fit.preval[, ndx\_min] }\OperatorTok{>}\StringTok{ }\FloatTok{0.5}\NormalTok{, }\StringTok{"HCC"}\NormalTok{, }\StringTok{"Control"}
\NormalTok{      )}
\NormalTok{      oofPred\_min\_error <{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(oofPred\_min\_vec }\OperatorTok{!=}\StringTok{ }\NormalTok{sim\_stage\_group\_vec)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SIM <{-}}\StringTok{ "Sim\_01"}

\ControlFlowTok{for}\NormalTok{(SIM }\ControlFlowTok{in} \KeywordTok{unique}\NormalTok{(sim\_results\_frm}\OperatorTok{$}\NormalTok{SimNo))\{}

\NormalTok{somNo\_results\_frm <{-}}\StringTok{ }\NormalTok{sim\_results\_frm }\OperatorTok{\%>\%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(SimNo}\OperatorTok{==}\NormalTok{SIM)}
...
\ControlFlowTok{for}\NormalTok{(VAR }\ControlFlowTok{in} \KeywordTok{c}\NormalTok{(}\StringTok{"p\_1se"}\NormalTok{, }\StringTok{"cv\_1se"}\NormalTok{, }\StringTok{"oof\_1se"}\NormalTok{, }\StringTok{"test\_1se"}\NormalTok{))\{}
\NormalTok{   var\_lst <{-}}\StringTok{ }\KeywordTok{split}\NormalTok{(somNo\_results\_frm[, VAR], somNo\_results\_frm}\OperatorTok{$}\NormalTok{Size)}
   \KeywordTok{names}\NormalTok{(var\_lst) <{-}}\StringTok{ }\NormalTok{SIZE}
   \KeywordTok{boxplot}\NormalTok{(var\_lst, }\DataTypeTok{main=}\NormalTok{VAR)}
\NormalTok{\}}
...
\CommentTok{\# min}
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{), }\DataTypeTok{mar=}\KeywordTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{), }\DataTypeTok{oma=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{0}\NormalTok{))}
\ControlFlowTok{for}\NormalTok{(VAR }\ControlFlowTok{in} \KeywordTok{c}\NormalTok{(}\StringTok{"p\_min"}\NormalTok{, }\StringTok{"cv\_min"}\NormalTok{, }\StringTok{"oof\_min"}\NormalTok{, }\StringTok{"test\_min"}\NormalTok{))\{}
\NormalTok{   var\_lst <{-}}\StringTok{ }\KeywordTok{split}\NormalTok{(somNo\_results\_frm[, VAR], somNo\_results\_frm}\OperatorTok{$}\NormalTok{Size)}
   \KeywordTok{names}\NormalTok{(var\_lst) <{-}}\StringTok{ }\NormalTok{SIZE}
   \KeywordTok{boxplot}\NormalTok{(var\_lst, }\DataTypeTok{main=}\NormalTok{VAR)}
\NormalTok{\}}
...
\includegraphics{Static/figures/simRes-Sim1-1se-1.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-2.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-3.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-4.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-5.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-6.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-7.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-8.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-9.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-10.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-11.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-12.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-13.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-14.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-15.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-16.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-17.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-18.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-19.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-20.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-21.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-22.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-23.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-24.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-25.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-26.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-27.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-28.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-29.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-30.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-31.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-32.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-33.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-34.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-35.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-36.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-37.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-38.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-39.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-40.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-41.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-42.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-43.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-44.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-45.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-46.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-47.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-48.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-49.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-50.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-51.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-52.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-53.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-54.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-55.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-56.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-57.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-58.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-59.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-60.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-61.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-62.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-63.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-64.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-65.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-66.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-67.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-68.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-69.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-70.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-71.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-72.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-73.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-74.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-75.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-76.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-77.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-78.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-79.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-80.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-81.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-82.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-83.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-84.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-85.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-86.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-87.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-88.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-89.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-90.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-91.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-92.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-93.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-94.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-95.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-96.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-97.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-98.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-99.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-100.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-101.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-102.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-103.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-104.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-105.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-106.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-107.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-108.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-109.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-110.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-111.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-112.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-113.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-114.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-115.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-116.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-117.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-118.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-119.pdf} \includegraphics{Static/figures/simRes-Sim1-1se-120.pdf}
