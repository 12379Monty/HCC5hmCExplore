...
assign(sub('GSE112679_','',OBJ), get(OBJ))
...
# rename sampDesc - this seems to help with  masking
sampDescA <- sampDesc
...
# also rename genes_annot
genes_annotA <- genes_annot
...
genes.ndx <- match(rownames(featureCountsAF), genes_annotA$Symbol)
if(sum(is.na(genes.ndx))) stop("featureCountsA/genes_annotA mismatch")
genes_annotAF <- genes_annotA[genes.ndx,]
