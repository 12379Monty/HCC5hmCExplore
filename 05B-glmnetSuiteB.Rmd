#  Sample size investigation - Continued {#model-suiteB}
...
```{r enet-feature-list-1se, cache=T, cache.vars=c('genes_by_rep_1se_tbl','enetAll_coef_1se_mtx'), fig.height=5, fig.width=8, fig.cap="Feature list stability for one standard error rule models"}
### CLEAR CACHE
...
-->
```{r enet-extract-sim-results, cache=T, cache.vars='enet_sim_results_frm', include=F}
# CLEAR CACHE 
...
```{r enet-sum-table, cache=T, cache.vars='', fig.cap='Simution results table', include=F}
# CLEAR CACHE 
...
### enet Simulation Results Look at one simulation
...
```{r enet-simRes-errors-overSim, cache=T, cache.vars=c('error_1se_Bysize_lst','error_min_Bysize_lst'), fig.heigth=5, fig.width=10, fig.cap='enet Model Errors by Sample Size'}
...
```{r print-enet-simRes-errors-overSim, cache=T, cache.vars='', fig.cap='enet Model Errors by Sample Size'}
...
knitr::kable(error_1se_Bysize_sum_frm,
    caption = paste("1se lambda enet error rates by sample size across simulations"),
    digits=2) %>%
   kableExtra::kable_styling(full_width = F)
...
knitr::kable(error_min_Bysize_sum_frm,
    caption = paste("min lambda enet error rates by sample size across simulations"),
    digits=2) %>%
   kableExtra::kable_styling(full_width = F)
...
```{r enet-simRes-features-OverSim, cache=T, cache.vars=c('p_singP_1se_Bysize_lst','p_singP_min_Bysize_lst'), fig.heigth=5, fig.width=10, fig.cap='enet Models Selected Features by Sample Size'}
...
```{r print-enet-simRes-features-OverSim, cache=T, cache.vars='', fig.cap='enet Models Selected Features by Sample Size'}
...
knitr::kable(p_sing_1se_Bysize_sum_frm,
    caption = paste("1se lambda enet feature selection sample size across simulations"),
    digits=2) %>%
   kableExtra::kable_styling(full_width = F)
...
knitr::kable(p_sing_min_Bysize_sum_frm,
    caption = paste("min lambda enet feature selection sample size across simulations"),
    digits=2) %>%
   kableExtra::kable_styling(full_width = F)
