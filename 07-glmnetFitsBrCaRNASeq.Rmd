...
```{r brca-rnaseseq-logistic_f, echo=F}
...
points(
 ...
 col=ifelse(train_group_vec[rownames(missclass_oofProb_mtx)[RR]] == 'Other',
  'green', 'red'),
...
points(
 rep(RR, ncol(missclass_oofProb_mtx)), 
 missclass_oofProb_mtx[RR,],
 col=ifelse(test_group_vec[rownames(missclass_oofProb_mtx)[RR]] == 'Other',
  'green', 'red'),
 pch=1:ncol(missclass_oofProb_mtx))
