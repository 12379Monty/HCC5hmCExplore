...
on the right side of Figure \@ref(fig:hcc5hmC-glmnetFit-get-sample-pred).  
...
We saw in Table \@ref(tab:hcc5hmC-glmnetFit-model-size-lassoAll) that the number of features
