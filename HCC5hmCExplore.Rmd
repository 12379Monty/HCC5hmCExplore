...
```{r look-sim-qual-0-50ONLY, cache=T, cache.vars=c('sim_control_qual_mtx', 'sim_affected_qual_mtx'), fig.height=8, fig.width=10, fig.cap='sample quality by simulation run for size = 50 '}
### CLEAR CACHE
...
```{r small-sample-qual, cache=T, cache.vars=c(''), fig.cap='sample quality vs classifier performance'}
